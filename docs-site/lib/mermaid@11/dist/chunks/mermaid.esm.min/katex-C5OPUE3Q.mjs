import {a as d} from "./chunk-AQ6EADP3.mjs";

var A = class r extends Error {
        static {
            d(this, "ParseError")
        }
        ...
        constructor(e, t) {
            ...
            if (u && u.start <= u.end) {
                ...
                var b;
                l + 15 < h.length ? b = h.slice(l, l + 15) + "\u2026" : b = h.slice(l), a += p + c + b
            }
            super(a), this.name = "ParseError", Object.setPrototypeOf(this, r.prototype), this.position = n, n != null && l != null && (this.length = l - n), this.rawMessage = e
        }
    }, F1 = /([A-Z])/g, Ot = d(r => r.replace(F1, "-$1").toLowerCase(), "hyphenate"),
    L1 = {"&": "&amp;", ">": "&gt;", "<": "&lt;", '"': "&quot;", "'": "&#x27;"}, P1 = /[&><"']/g,
    l0 = d(r => String(r).replace(P1, e => L1[e]), "escape"),
    Oe = d(r => r.type === "ordgroup" || r.type === "color" ? r.body.length === 1 ? Oe(r.body[0]) : r : r.type === "font" ? Oe(r.body) : r, "getBaseElem"),
    G1 = new Set(["mathord", "textord", "atom"]), E0 = d(r => G1.has(Oe(r).type), "isCharacterBox"), U1 = d(r => {
        ...
        errorColor: {
            ...
            cliProcessor: d(r => "#" + r, "cliProcessor")
        },
        macros: {
            type: "object",
            cli: "-m, --macro <def>",
            ...
            cliDefault: [],
            cliProcessor: d((r, e) => (e.push(r), e), "cliProcessor")
        },
        minRuleThickness: {
            type: "number",
        ...
        maxExpand: {
            ...
            processor: d(r => Math.max(0, r), "processor"),
            cli: "-e, --max-expand <n>",
            cliProcessor: d(r => r === "Infinity" ? 1 / 0 : parseInt(r), "cliProcessor")
        },
...
var de = class {
        ...
        constructor(e) {
            e === void 0 && (e = {}), e = e || {};
            for (var t of Object.keys(xt)) {
                var a = xt[t], n = e[t];
                this[t] = n !== void 0 ? a.processor ? a.processor(n) : n : V1(a)
            }
        }
        ...
        reportNonstrict(e, t, a) {
            ...
            if (typeof n == "function" && (n = n(e, t, a)), !(!n || n === "ignore")) {
                if (n === !0 || n === "error") throw new A("LaTeX-incompatible input and strict mode is set to 'error': " + (t + " [" + e + "]"), a);
        ...
        sup() {
            return z0[X1[this.id]]
        }

        sub() {
            return z0[Y1[this.id]]
        }

        fracNum() {
            return z0[W1[this.id]]
        }
        ...
        cramp() {
            return z0[j1[this.id]]
        }

        text() {
            return z0[Z1[this.id]]
        }

        isTight() {
            return this.size >= 2
        }
    }, Ht = 0, Fe = 1, te = 2, R0 = 3, fe = 4, b0 = 5, re = 6, o0 = 7,
    z0 = [new S0(Ht, 0, !1), new S0(Fe, 0, !0), new S0(te, 1, !1), new S0(R0, 1, !0), new S0(fe, 2, !1), new S0(b0, 2, !0), new S0(re, 3, !1), new S0(o0, 3, !0)],
    X1 = [fe, b0, fe, b0, re, o0, re, o0], Y1 = [b0, b0, b0, b0, o0, o0, o0, o0], W1 = [te, R0, fe, b0, re, o0, re, o0],
    $1 = [R0, R0, b0, b0, o0, o0, o0, o0], j1 = [Fe, Fe, R0, R0, b0, b0, o0, o0], Z1 = [Ht, Fe, te, R0, te, R0, te, R0],
    O = {DISPLAY: z0[Ht], TEXT: z0[te], SCRIPT: z0[fe], SCRIPTSCRIPT: z0[re]},
    wt = [{name: "latin", blocks: [[256, 591], [768, 879]]}, {
        name: "cyrillic",
        blocks: [[1024, 1279]]
...
function K1(r) {
    for (var e = 0; e < wt.length; e++) for (var t = wt[e], a = 0; a < t.blocks.length; a++) {
        var n = t.blocks[a];
...
d(K1, "scriptFromCodepoint");
var He = [];
wt.forEach(r => r.blocks.forEach(e => He.push(...e)));

function Nr(r) {
    for (var e = 0; e < He.length; e += 2) if (r >= He[e] && r <= He[e + 1]) return !0;
    return !1
}

d(Nr, "supportedCodepoint");
var a0 = d(r => r + " " + r, "doubleBrushStroke"), ee = 80, J1 = d(function (e, t) {
    return "M95," + (622 + e + t) + `
...
}, "sqrtSize4"), ra = d(function (e) {
    var t = e / 2;
    return "M400000 " + e + " H0 L" + t + " 0 l65 45 L145 " + (e - 80) + " H400000z"
}, "phasePath"), aa = d(function (e, t, a) {
    var n = a - 54 - t - e;
...
-470,-1265c-4.7,-6,-9.7,-11.7,-15,-17c-0.7,-0.7,-6.7,-1,-18,-1z`;
    ...
    sp: 1 / 65536,
    px: 803 / 800
}, sa = {ex: !0, em: !0, mu: !0}, Or = d(function (e) {
    return typeof e != "string" && (e = e.unit), e in kt || e in sa || e === "ex"
}, "validUnit"), Q = d(function (e, t) {
    var a;
    if (e.unit in kt) a = kt[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier; else if (e.unit === "mu") a = t.fontMetrics().cssEmPerMu; else {
        var n;
        if (t.style.isTight() ? n = t.havingStyle(t.style.text()) : n = t, e.unit === "ex") a = n.fontMetrics().xHeight; else if (e.unit === "em") a = n.fontMetrics().quad; else throw new A("Invalid unit: '" + e.unit + "'");
        n !== t && (a *= n.sizeMultiplier / t.sizeMultiplier)
    }
    return Math.min(e.number * a, t.maxSize)
}, "calculateSize"), M = d(function (e) {
    return +e.toFixed(4) + "em"
}, "makeEm"), U0 = d(function (e) {
    return e.filter(t => t).join(" ")
}, "createClass"), Hr = d(function (e, t, a) {
    ...
    return t
}, "toNode"), ua = /[\s"'>/=\x00-\x1f]/, Lr = d(function (e) {
    var t = "<" + e;
    this.classes.length && (t += ' class="' + l0(U0(this.classes)) + '"');
    var a = "";
    for (var n of Object.keys(this.style)) a += Ot(n) + ":" + this.style[n] + ";";
    a && (t += ' style="' + l0(a) + '"');
    for (var l of Object.keys(this.attributes)) {
        if (ua.test(l)) throw new A("Invalid attribute name '" + l + "'");
        t += " " + l + '="' + l0(this.attributes[l]) + '"'
    }
    t += ">";
    ...
    constructor(e, t, a, n) {
        Hr.call(this, e, a, n), this.children = t || []
    }
    ...
    constructor(e, t, a, n) {
        Hr.call(this, t, n), this.children = a || [], this.setAttribute("href", e)
    }
    ...
    toMarkup() {
        var e = '<img src="' + l0(this.src) + '"' + (' alt="' + l0(this.alt) + '"'), t = "";
        for (var a of Object.keys(this.style)) t += Ot(a) + ":" + this.style[a] + ";";
        return t && (e += ' style="' + l0(t) + '"'), e += "'/>", e
    }
}, oa = {\u00EE: "\u0131\u0302", \u00EF: "\u0131\u0308", \u00ED: "\u0131\u0301", \u00EC: "\u0131\u0300"}, h0 = class {
    static {
        d(this, "SymbolNode")
    }
    ...
    constructor(e, t, a, n, l, u, h, c) {
        ...
        var p = K1(this.text.charCodeAt(0));
        p && this.classes.push(p + "_fallback"), /[îïíì]/.test(this.text) && (this.text = oa[this.text])
    }
    ...
    toNode() {
        ...
        this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = M(this.italic)), this.classes.length > 0 && (t = t || document.createElement("span"), t.className = U0(this.classes));
    ...
    toMarkup() {
        var e = !1, t = "<span";
        this.classes.length && (e = !0, t += ' class="', t += l0(U0(this.classes)), t += '"');
        var a = "";
    ...
    toNode() {
        ...
        return this.alternate ? t.setAttribute("d", this.alternate) : t.setAttribute("d", lr[this.pathName]), t
    }

    toMarkup() {
        return this.alternate ? '<path d="' + l0(this.alternate) + '"/>' : '<path d="' + l0(lr[this.pathName]) + '"/>'
    }
}, ve = class {
    static {
        d(this, "LineNode")
...
d(ma, "assertSpan");
var ca = d(r => r instanceof V0 || r instanceof ae || r instanceof G0, "hasHtmlDomChildren"), A0 = {
    "AMS-Regular": {
        32: [0, 0, 0, 0, .25],
...
function Ft(r, e, t) {
    if (!A0[e]) throw new Error("Font metrics not found for font: " + e + ".");
    var a = r.charCodeAt(0), n = A0[e][a];
    if (!n && r[0] in sr && (a = sr[r[0]].charCodeAt(0), n = A0[e][a]), !n && t === "text" && Nr(a) && (n = A0[e][77]), n) return {
        depth: n[0],
        height: n[1],
        italic: n[2],
        skew: n[3],
...
d(Ft, "getCharacterMetrics");
var lt = {};

function fa(r) {
    var e;
    if (r >= 5 ? e = 0 : r >= 3 ? e = 1 : e = 2, !lt[e]) {
        var t = lt[e] = {cssEmPerMu: Ae.quad[e] / 18};
        for (var a in Ae) Ae.hasOwnProperty(a) && (t[a] = Ae[a][e])
    }
    return lt[e]
}

d(fa, "getGlobalMetrics");
var va = {bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1},
    pa = {"accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1}, j = {math: {}, text: {}};
...
d(i, "defineSymbol");
var s = "math", k = "text", o = "main", f = "ams", Z = "accent-token", C = "bin", m0 = "close", le = "inner",
    E = "mathord", t0 = "op-token", p0 = "open", ge = "punct", v = "rel", I0 = "spacing", g = "textord";
i(s, o, v, "\u2261", "\\equiv", !0);
i(s, o, v, "\u227A", "\\prec", !0);
i(s, o, v, "\u227B", "\\succ", !0);
i(s, o, v, "\u223C", "\\sim", !0);
...
i(s, o, v, "\u22C8", "\\bowtie", !0);
i(s, o, v, "\u2323", "\\smile", !0);
i(s, o, v, "\u2291", "\\sqsubseteq", !0);
i(s, o, v, "\u2292", "\\sqsupseteq", !0);
i(s, o, v, "\u2250", "\\doteq", !0);
i(s, o, v, "\u2322", "\\frown", !0);
i(s, o, v, "\u220B", "\\ni", !0);
i(s, o, v, "\u221D", "\\propto", !0);
...
i(s, o, g, "\u2021", "\\ddag");
i(k, o, g, "\u2021", "\\ddag");
i(k, o, g, "\u2021", "\\textdaggerdbl");
i(s, o, m0, "\u23B1", "\\rmoustache", !0);
...
i(s, o, C, "\u2A3F", "\\amalg");
i(s, o, C, "&", "\\And");
i(s, o, v, "\u27F5", "\\longleftarrow", !0);
i(s, o, v, "\u21D0", "\\Leftarrow", !0);
i(s, o, v, "\u27F8", "\\Longleftarrow", !0);
i(s, o, v, "\u27F6", "\\longrightarrow", !0);
i(s, o, v, "\u21D2", "\\Rightarrow", !0);
i(s, o, v, "\u27F9", "\\Longrightarrow", !0);
i(s, o, v, "\u2194", "\\leftrightarrow", !0);
i(s, o, v, "\u27F7", "\\longleftrightarrow", !0);
i(s, o, v, "\u21D4", "\\Leftrightarrow", !0);
i(s, o, v, "\u27FA", "\\Longleftrightarrow", !0);
i(s, o, v, "\u21A6", "\\mapsto", !0);
i(s, o, v, "\u27FC", "\\longmapsto", !0);
i(s, o, v, "\u2197", "\\nearrow", !0);
i(s, o, v, "\u21A9", "\\hookleftarrow", !0);
i(s, o, v, "\u21AA", "\\hookrightarrow", !0);
i(s, o, v, "\u2198", "\\searrow", !0);
i(s, o, v, "\u21BC", "\\leftharpoonup", !0);
i(s, o, v, "\u21C0", "\\rightharpoonup", !0);
i(s, o, v, "\u2199", "\\swarrow", !0);
i(s, o, v, "\u21BD", "\\leftharpoondown", !0);
i(s, o, v, "\u21C1", "\\rightharpoondown", !0);
i(s, o, v, "\u2196", "\\nwarrow", !0);
i(s, o, v, "\u21CC", "\\rightleftharpoons", !0);
i(s, f, v, "\u226E", "\\nless", !0);
i(s, f, v, "\uE010", "\\@nleqslant");
i(s, f, v, "\uE011", "\\@nleqq");
i(s, f, v, "\u2A87", "\\lneq", !0);
...
i(s, f, v, "\u22EC", "\\ntrianglelefteq", !0);
i(s, f, v, "\u228A", "\\subsetneq", !0);
i(s, f, v, "\uE01A", "\\@varsubsetneq");
i(s, f, v, "\u2ACB", "\\subsetneqq", !0);
i(s, f, v, "\uE017", "\\@varsubsetneqq");
i(s, f, v, "\u226F", "\\ngtr", !0);
i(s, f, v, "\uE00F", "\\@ngeqslant");
i(s, f, v, "\uE00E", "\\@ngeqq");
i(s, f, v, "\u2A88", "\\gneq", !0);
...
i(s, f, v, "\u22E1", "\\nsucceq", !0);
i(s, f, v, "\u22E9", "\\succnsim", !0);
i(s, f, v, "\u2ABA", "\\succnapprox", !0);
i(s, f, v, "\u2246", "\\ncong", !0);
i(s, f, v, "\uE007", "\\@nshortparallel");
i(s, f, v, "\u2226", "\\nparallel", !0);
i(s, f, v, "\u22AF", "\\nVDash", !0);
i(s, f, v, "\u22EB", "\\ntriangleright");
i(s, f, v, "\u22ED", "\\ntrianglerighteq", !0);
i(s, f, v, "\uE018", "\\@nsupseteqq");
i(s, f, v, "\u228B", "\\supsetneq", !0);
i(s, f, v, "\uE01B", "\\@varsupsetneq");
i(s, f, v, "\u2ACC", "\\supsetneqq", !0);
i(s, f, v, "\uE019", "\\@varsupsetneqq");
i(s, f, v, "\u22AE", "\\nVdash", !0);
i(s, f, v, "\u2AB5", "\\precneqq", !0);
i(s, f, v, "\u2AB6", "\\succneqq", !0);
i(s, f, v, "\uE016", "\\@nsubseteqq");
...
i(k, f, g, "\xAE", "\\circledR");
i(s, f, g, "\u2221", "\\measuredangle", !0);
i(s, f, g, "\u2204", "\\nexists");
i(s, f, g, "\u2127", "\\mho");
i(s, f, g, "\u2132", "\\Finv", !0);
i(s, f, g, "\u2141", "\\Game", !0);
i(s, f, g, "\u2035", "\\backprime");
i(s, f, g, "\u25B2", "\\blacktriangle");
i(s, f, g, "\u25BC", "\\blacktriangledown");
i(s, f, g, "\u25A0", "\\blacksquare");
i(s, f, g, "\u29EB", "\\blacklozenge");
i(s, f, g, "\u2605", "\\bigstar");
i(s, f, g, "\u2222", "\\sphericalangle", !0);
i(s, f, g, "\u2201", "\\complement", !0);
i(s, f, g, "\xF0", "\\eth", !0);
i(k, o, g, "\xF0", "\xF0");
i(s, f, g, "\u2571", "\\diagup");
i(s, f, g, "\u2572", "\\diagdown");
...
i(s, f, v, "\u2266", "\\leqq", !0);
i(s, f, v, "\u2A7D", "\\leqslant", !0);
i(s, f, v, "\u2A95", "\\eqslantless", !0);
i(s, f, v, "\u2272", "\\lesssim", !0);
i(s, f, v, "\u2A85", "\\lessapprox", !0);
i(s, f, v, "\u224A", "\\approxeq", !0);
i(s, f, C, "\u22D6", "\\lessdot");
i(s, f, v, "\u22D8", "\\lll", !0);
i(s, f, v, "\u2276", "\\lessgtr", !0);
i(s, f, v, "\u22DA", "\\lesseqgtr", !0);
i(s, f, v, "\u2A8B", "\\lesseqqgtr", !0);
i(s, f, v, "\u2251", "\\doteqdot");
i(s, f, v, "\u2253", "\\risingdotseq", !0);
i(s, f, v, "\u2252", "\\fallingdotseq", !0);
i(s, f, v, "\u223D", "\\backsim", !0);
i(s, f, v, "\u22CD", "\\backsimeq", !0);
i(s, f, v, "\u2AC5", "\\subseteqq", !0);
i(s, f, v, "\u22D0", "\\Subset", !0);
i(s, f, v, "\u228F", "\\sqsubset", !0);
i(s, f, v, "\u227C", "\\preccurlyeq", !0);
i(s, f, v, "\u22DE", "\\curlyeqprec", !0);
i(s, f, v, "\u227E", "\\precsim", !0);
i(s, f, v, "\u2AB7", "\\precapprox", !0);
i(s, f, v, "\u22B2", "\\vartriangleleft");
i(s, f, v, "\u22B4", "\\trianglelefteq");
i(s, f, v, "\u22A8", "\\vDash", !0);
i(s, f, v, "\u22AA", "\\Vvdash", !0);
i(s, f, v, "\u2323", "\\smallsmile");
i(s, f, v, "\u2322", "\\smallfrown");
...
i(s, f, v, "\u22D1", "\\Supset", !0);
i(s, f, v, "\u2290", "\\sqsupset", !0);
i(s, f, v, "\u227D", "\\succcurlyeq", !0);
i(s, f, v, "\u22DF", "\\curlyeqsucc", !0);
i(s, f, v, "\u227F", "\\succsim", !0);
i(s, f, v, "\u2AB8", "\\succapprox", !0);
i(s, f, v, "\u22B3", "\\vartriangleright");
i(s, f, v, "\u22B5", "\\trianglerighteq");
i(s, f, v, "\u22A9", "\\Vdash", !0);
i(s, f, v, "\u2223", "\\shortmid");
i(s, f, v, "\u2225", "\\shortparallel");
i(s, f, v, "\u226C", "\\between", !0);
i(s, f, v, "\u22D4", "\\pitchfork", !0);
i(s, f, v, "\u221D", "\\varpropto");
i(s, f, v, "\u25C0", "\\blacktriangleleft");
i(s, f, v, "\u2234", "\\therefore", !0);
i(s, f, v, "\u220D", "\\backepsilon");
i(s, f, v, "\u25B6", "\\blacktriangleright");
i(s, f, v, "\u2235", "\\because", !0);
i(s, f, v, "\u22D8", "\\llless");
i(s, f, v, "\u22D9", "\\gggtr");
i(s, f, C, "\u22B2", "\\lhd");
...
i(s, f, v, "\u2251", "\\Doteq", !0);
i(s, f, C, "\u2214", "\\dotplus", !0);
i(s, f, C, "\u2216", "\\smallsetminus");
i(s, f, C, "\u22D2", "\\Cap", !0);
i(s, f, C, "\u22D3", "\\Cup", !0);
i(s, f, C, "\u2A5E", "\\doublebarwedge", !0);
i(s, f, C, "\u229F", "\\boxminus", !0);
i(s, f, C, "\u229E", "\\boxplus", !0);
i(s, f, C, "\u22C7", "\\divideontimes", !0);
i(s, f, C, "\u22C9", "\\ltimes", !0);
i(s, f, C, "\u22CA", "\\rtimes", !0);
i(s, f, C, "\u22CB", "\\leftthreetimes", !0);
i(s, f, C, "\u22CC", "\\rightthreetimes", !0);
i(s, f, C, "\u22CF", "\\curlywedge", !0);
i(s, f, C, "\u22CE", "\\curlyvee", !0);
i(s, f, C, "\u229D", "\\circleddash", !0);
i(s, f, C, "\u229B", "\\circledast", !0);
i(s, f, C, "\u22C5", "\\centerdot");
i(s, f, C, "\u22BA", "\\intercal", !0);
i(s, f, C, "\u22D2", "\\doublecap");
i(s, f, C, "\u22D3", "\\doublecup");
i(s, f, C, "\u22A0", "\\boxtimes", !0);
i(s, f, v, "\u21E2", "\\dashrightarrow", !0);
i(s, f, v, "\u21E0", "\\dashleftarrow", !0);
i(s, f, v, "\u21C7", "\\leftleftarrows", !0);
i(s, f, v, "\u21C6", "\\leftrightarrows", !0);
i(s, f, v, "\u21DA", "\\Lleftarrow", !0);
i(s, f, v, "\u219E", "\\twoheadleftarrow", !0);
i(s, f, v, "\u21A2", "\\leftarrowtail", !0);
i(s, f, v, "\u21AB", "\\looparrowleft", !0);
i(s, f, v, "\u21CB", "\\leftrightharpoons", !0);
i(s, f, v, "\u21B6", "\\curvearrowleft", !0);
i(s, f, v, "\u21BA", "\\circlearrowleft", !0);
i(s, f, v, "\u21B0", "\\Lsh", !0);
i(s, f, v, "\u21C8", "\\upuparrows", !0);
i(s, f, v, "\u21BF", "\\upharpoonleft", !0);
i(s, f, v, "\u21C3", "\\downharpoonleft", !0);
i(s, o, v, "\u22B6", "\\origof", !0);
i(s, o, v, "\u22B7", "\\imageof", !0);
i(s, f, v, "\u22B8", "\\multimap", !0);
i(s, f, v, "\u21AD", "\\leftrightsquigarrow", !0);
i(s, f, v, "\u21C9", "\\rightrightarrows", !0);
i(s, f, v, "\u21C4", "\\rightleftarrows", !0);
i(s, f, v, "\u21A0", "\\twoheadrightarrow", !0);
i(s, f, v, "\u21A3", "\\rightarrowtail", !0);
i(s, f, v, "\u21AC", "\\looparrowright", !0);
i(s, f, v, "\u21B7", "\\curvearrowright", !0);
i(s, f, v, "\u21BB", "\\circlearrowright", !0);
i(s, f, v, "\u21B1", "\\Rsh", !0);
i(s, f, v, "\u21CA", "\\downdownarrows", !0);
i(s, f, v, "\u21BE", "\\upharpoonright", !0);
i(s, f, v, "\u21C2", "\\downharpoonright", !0);
i(s, f, v, "\u21DD", "\\rightsquigarrow", !0);
i(s, f, v, "\u21DD", "\\leadsto");
i(s, f, v, "\u21DB", "\\Rrightarrow", !0);
i(s, f, v, "\u21BE", "\\restriction");
i(s, o, g, "\u2018", "`");
i(s, o, g, "$", "\\$");
i(k, o, g, "$", "\\$");
...
i(s, o, g, "\u2202", "\\partial", !0);
i(s, o, C, "\u2298", "\\oslash", !0);
i(s, f, C, "\u229A", "\\circledcirc", !0);
i(s, f, C, "\u22A1", "\\boxdot", !0);
i(s, o, C, "\u25B3", "\\bigtriangleup");
i(s, o, C, "\u25BD", "\\bigtriangledown");
i(s, o, C, "\u2020", "\\dagger");
i(s, o, C, "\u22C4", "\\diamond");
i(s, o, C, "\u22C6", "\\star");
i(s, o, C, "\u25C3", "\\triangleleft");
i(s, o, C, "\u25B9", "\\triangleright");
i(s, o, p0, "{", "\\{");
i(k, o, g, "{", "\\{");
i(k, o, g, "{", "\\textbraceleft");
i(s, o, m0, "}", "\\}");
i(k, o, g, "}", "\\}");
i(k, o, g, "}", "\\textbraceright");
i(s, o, p0, "{", "\\lbrace");
i(s, o, m0, "}", "\\rbrace");
i(s, o, p0, "[", "\\lbrack", !0);
i(k, o, g, "[", "\\lbrack", !0);
...
i(s, o, g, "\u2225", "\\Vert");
i(k, o, g, "\u2225", "\\textbardbl");
i(k, o, g, "~", "\\textasciitilde");
i(k, o, g, "\\", "\\textbackslash");
i(k, o, g, "^", "\\textasciicircum");
i(s, o, v, "\u2191", "\\uparrow", !0);
i(s, o, v, "\u21D1", "\\Uparrow", !0);
i(s, o, v, "\u2193", "\\downarrow", !0);
i(s, o, v, "\u21D3", "\\Downarrow", !0);
i(s, o, v, "\u2195", "\\updownarrow", !0);
i(s, o, v, "\u21D5", "\\Updownarrow", !0);
i(s, o, t0, "\u2210", "\\coprod");
i(s, o, t0, "\u22C1", "\\bigvee");
i(s, o, t0, "\u22C0", "\\bigwedge");
...
i(s, o, t0, "\u2A06", "\\bigsqcup");
i(s, o, t0, "\u222B", "\\smallint");
i(k, o, le, "\u2026", "\\textellipsis");
i(s, o, le, "\u2026", "\\mathellipsis");
i(k, o, le, "\u2026", "\\ldots", !0);
i(s, o, le, "\u2026", "\\ldots", !0);
i(s, o, le, "\u22EF", "\\@cdots", !0);
i(s, o, le, "\u22F1", "\\ddots", !0);
...
i(k, o, g, "\u2014", "\\textemdash");
i(k, o, g, "\u2018", "`", !0);
i(k, o, g, "\u2018", "\\textquoteleft");
i(k, o, g, "\u2019", "'", !0);
i(k, o, g, "\u2019", "\\textquoteright");
i(k, o, g, "\u201C", "``", !0);
i(k, o, g, "\u201C", "\\textquotedblleft");
i(k, o, g, "\u201D", "''", !0);
i(k, o, g, "\u201D", "\\textquotedblright");
i(s, o, g, "\xB0", "\\degree", !0);
i(k, o, g, "\xB0", "\\degree");
i(k, o, g, "\xB0", "\\textdegree", !0);
i(s, o, g, "\xA3", "\\pounds");
i(s, o, g, "\xA3", "\\mathsterling", !0);
i(k, o, g, "\xA3", "\\pounds");
i(k, o, g, "\xA3", "\\textsterling", !0);
i(s, f, g, "\u2720", "\\maltese");
i(k, f, g, "\u2720", "\\maltese");
var ur = '0123456789/@."';
for (Me = 0; Me < ur.length; Me++) st = ur.charAt(Me), i(s, o, g, st, st);
var st, Me, or = '0123456789!@*()-=+";:?/.,';
for (Te = 0; Te < or.length; Te++) ut = or.charAt(Te), i(k, o, g, ut, ut);
var ut, Te, Le = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
for (Be = 0; Be < Le.length; Be++) oe = Le.charAt(Be), i(s, o, E, oe, oe), i(k, o, g, oe, oe);
var oe, Be;
i(s, f, g, "C", "\u2102");
i(k, f, g, "C", "\u2102");
i(s, f, g, "H", "\u210D");
...
i(k, o, E, "h", "\u210E");
var I = "";
for (i0 = 0; i0 < Le.length; i0++) K = Le.charAt(i0), I = String.fromCharCode(55349, 56320 + i0), i(s, o, E, K, I), i(k, o, g, K, I), I = String.fromCharCode(55349, 56372 + i0), i(s, o, E, K, I), i(k, o, g, K, I), I = String.fromCharCode(55349, 56424 + i0), i(s, o, E, K, I), i(k, o, g, K, I), I = String.fromCharCode(55349, 56580 + i0), i(s, o, E, K, I), i(k, o, g, K, I), I = String.fromCharCode(55349, 56684 + i0), i(s, o, E, K, I), i(k, o, g, K, I), I = String.fromCharCode(55349, 56736 + i0), i(s, o, E, K, I), i(k, o, g, K, I), I = String.fromCharCode(55349, 56788 + i0), i(s, o, E, K, I), i(k, o, g, K, I), I = String.fromCharCode(55349, 56840 + i0), i(s, o, E, K, I), i(k, o, g, K, I), I = String.fromCharCode(55349, 56944 + i0), i(s, o, E, K, I), i(k, o, g, K, I), i0 < 26 && (I = String.fromCharCode(55349, 56632 + i0), i(s, o, E, K, I), i(k, o, g, K, I), I = String.fromCharCode(55349, 56476 + i0), i(s, o, E, K, I), i(k, o, g, K, I));
var K, i0;
I = "\u{1D55C}";
i(s, o, E, "k", I);
i(k, o, g, "k", I);
for (L0 = 0; L0 < 10; L0++) C0 = L0.toString(), I = String.fromCharCode(55349, 57294 + L0), i(s, o, E, C0, I), i(k, o, g, C0, I), I = String.fromCharCode(55349, 57314 + L0), i(s, o, E, C0, I), i(k, o, g, C0, I), I = String.fromCharCode(55349, 57324 + L0), i(s, o, E, C0, I), i(k, o, g, C0, I), I = String.fromCharCode(55349, 57334 + L0), i(s, o, E, C0, I), i(k, o, g, C0, I);
var C0, L0, zt = "\xD0\xDE\xFE";
for (De = 0; De < zt.length; De++) he = zt.charAt(De), i(s, o, E, he, he), i(k, o, g, he, he);
var he, De,
    Ce = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathnormal", "textit", "Math-Italic"], ["mathnormal", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathboldfrak", "textboldfrak", "Fraktur-Regular"], ["mathboldfrak", "textboldfrak", "Fraktur-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]],
    hr = [["mathbf", "textbf", "Main-Bold"], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathtt", "texttt", "Typewriter-Regular"]],
    ga = d((r, e) => {
        var t = r.charCodeAt(0), a = r.charCodeAt(1), n = (t - 55296) * 1024 + (a - 56320) + 65536,
            l = e === "math" ? 0 : 1;
        if (119808 <= n && n < 120484) {
            var u = Math.floor((n - 119808) / 26);
            return [Ce[u][2], Ce[u][l]]
        } else if (120782 <= n && n <= 120831) {
            var h = Math.floor((n - 120782) / 10);
            return [hr[h][2], hr[h][l]]
        } else {
            if (n === 120485 || n === 120486) return [Ce[0][2], Ce[0][l]];
            if (120486 < n && n < 120782) return ["", ""];
            throw new A("Unsupported character: " + r)
        }
    }, "wideCharacterFont"), $e = d(function (e, t, a) {
        if (j[a][e]) {
            var n = j[a][e].replace;
            n && (e = n)
        }
        return {value: e, metrics: Ft(e, t, a)}
    }, "lookupSymbol"), u0 = d(function (e, t, a, n, l) {
        var u = $e(e, t, a), h = u.metrics;
        e = u.value;
        var c;
        if (h) {
            var p = h.italic;
            (a === "text" || n && n.font === "mathit") && (p = 0), c = new h0(e, h.height, h.depth, p, h.skew, h.width, l)
        } else typeof console < "u" && console.warn("No character metrics " + ("for '" + e + "' in style '" + t + "' and mode '" + a + "'")), c = new h0(e, 0, 0, 0, 0, 0, l);
        if (n) {
        ...
        return c
    }, "makeSymbol"), Lt = d(function (e, t, a, n) {
        return n === void 0 && (n = []), a.font === "boldsymbol" && $e(e, "Main-Bold", t).metrics ? u0(e, "Main-Bold", t, a, n.concat(["mathbf"])) : e === "\\" || j[t][e].font === "main" ? u0(e, "Main-Regular", t, a, n) : u0(e, "AMS-Regular", t, a, n.concat(["amsrm"]))
    }, "mathsym"), ba = d(function (e, t, a, n, l) {
        return l !== "textord" && $e(e, "Math-BoldItalic", t).metrics ? {
            fontName: "Math-BoldItalic",
            fontClass: "boldsymbol"
        } : {fontName: "Main-Bold", fontClass: "mathbf"}
    }, "boldsymbol"), je = d(function (e, t, a) {
        var n = e.mode, l = e.text, u = ["mord"], h = n === "math" || n === "text" && t.font, c = h ? t.font : t.fontFamily,
            p = "", b = "";
        if (l.charCodeAt(0) === 55349 && ([p, b] = ga(l, n)), p.length > 0) return u0(l, p, n, t, u.concat(b));
        if (c) {
            var y, x;
            if (c === "boldsymbol") {
                var w = ba(l, n, t, u, a);
                y = w.fontName, x = [w.fontClass]
            } else h ? (y = At[c].fontName, x = [c]) : (y = qe(c, t.fontWeight, t.fontShape), x = [c, t.fontWeight, t.fontShape]);
            if ($e(l, y, n).metrics) return u0(l, y, n, t, u.concat(x));
            if (Pr.hasOwnProperty(l) && y.slice(0, 10) === "Typewriter") {
                for (var T = [], B = 0; B < l.length; B++) T.push(u0(l[B], y, n, t, u.concat(x)));
                return N0(T)
            }
        }
        if (a === "mathord") return u0(l, "Math-Italic", n, t, u.concat(["mathnormal"]));
        if (a === "textord") {
            var q = j[n][l] && j[n][l].font;
            if (q === "ams") {
                var R = qe("amsrm", t.fontWeight, t.fontShape);
                return u0(l, R, n, t, u.concat("amsrm", t.fontWeight, t.fontShape))
            } else if (q === "main" || !q) {
                var N = qe("textrm", t.fontWeight, t.fontShape);
                return u0(l, N, n, t, u.concat(t.fontWeight, t.fontShape))
            } else {
                var H = qe(q, t.fontWeight, t.fontShape);
                return u0(l, H, n, t, u.concat(H, t.fontWeight, t.fontShape))
            }
        } else throw new Error("unexpected type: " + a + " in makeOrd")
    }, "makeOrd"), ya = d((r, e) => {
        if (U0(r.classes) !== U0(e.classes) || r.skew !== e.skew || r.maxFontSize !== e.maxFontSize || r.italic !== 0 && r.hasClass("mathnormal")) return !1;
        ...
        for (var e = 0; e < r.length - 1; e++) {
            var t = r[e], a = r[e + 1];
            t instanceof h0 && a instanceof h0 && ya(t, a) && (t.text += a.text, t.height = Math.max(t.height, a.height), t.depth = Math.max(t.depth, a.depth), t.italic = a.italic, r.splice(e + 1, 1), e--)
        }
        return r
    }, "tryCombineChars"), Pt = d(function (e) {
    ...
    }, "sizeElementFromChildren"), S = d(function (e, t, a, n) {
        var l = new V0(e, t, a, n);
        return Pt(l), l
    }, "makeSpan"), X0 = d((r, e, t, a) => new V0(r, e, t, a), "makeSvgSpan"), ne = d(function (e, t, a) {
        var n = S([e], [], t);
    ...
    }, "makeLineSpan"), xa = d(function (e, t, a, n) {
        var l = new ae(e, t, a, n);
        return Pt(l), l
    }, "makeAnchor"), N0 = d(function (e) {
        var t = new G0(e);
        return Pt(t), t
    }, "makeFragment"), ie = d(function (e, t) {
        return e instanceof G0 ? S([], [e], t) : e
    }, "wrapFragment"), wa = d(function (e) {
        ...
        if (e.positionType === "top") {
            for (var b = e.positionData, y = 0; y < e.children.length; y++) {
                var x = e.children[y];
                b -= x.type === "kern" ? x.size : x.elem.height + x.elem.depth
            }
            p = b
        } else if (e.positionType === "bottom") p = -e.positionData; else {
            var w = e.children[0];
            if (w.type !== "elem") throw new Error('First child must have type "elem".');
            if (e.positionType === "shift") p = -w.elem.depth - e.positionData; else if (e.positionType === "firstBaseline") p = -w.elem.depth; else throw new Error("Invalid positionType " + e.positionType + ".")
        }
        return {children: e.children, depth: p}
    }, "getVListChildrenAndDepth"), U = d(function (e, t) {
        for (var {children: a, depth: n} = wa(e), l = 0, u = 0; u < a.length; u++) {
            var h = a[u];
            if (h.type === "elem") {
                var c = h.elem;
        ...
        var p = S(["pstrut"], []);
        p.style.height = M(l);
        for (var b = [], y = n, x = n, w = n, T = 0; T < a.length; T++) {
            var B = a[T];
            if (B.type === "kern") w += B.size; else {
                var q = B.elem, R = B.wrapperClasses || [], N = B.wrapperStyle || {}, H = S(R, [p, q], void 0, N);
                H.style.top = M(-l - w - q.depth), B.marginLeft && (H.style.marginLeft = B.marginLeft), B.marginRight && (H.style.marginRight = B.marginRight), b.push(H), w += q.height + q.depth
            }
        ...
        if (y < 0) {
            var P = S([], []), G = S(["vlist"], [P]);
            G.style.height = M(-y);
            var $ = S(["vlist-s"], [new h0("\u200B")]);
            X = [S(["vlist-r"], [L, $]), S(["vlist-r"], [G])]
        } else X = [S(["vlist-r"], [L])];
        var Y = S(["vlist-t"], X);
        return X.length === 2 && Y.classes.push("vlist-t2"), Y.height = x, Y.depth = -y, Y
    }, "makeVList"), Ur = d((r, e) => {
        var t = S(["mspace"], [], e), a = Q(r, e);
        return t.style.marginRight = M(a), t
    }, "makeGlue"), qe = d(function (e, t, a) {
        var n = "";
        switch (e) {
            case"amsrm":
                n = "AMS";
        ...
        var [a, n, l] = Vr[e], u = new M0(a), h = new k0([u], {
            width: M(n),
            height: M(l),
            style: "width:" + M(n),
    ...
    }, "staticSvg"), J = {number: 3, unit: "mu"}, j0 = {number: 4, unit: "mu"}, q0 = {number: 5, unit: "mu"}, ka = {
        mord: {mop: J, mbin: j0, mrel: q0, minner: J},
        mop: {mord: J, mop: J, mrel: q0, minner: J},
        mbin: {mord: j0, mop: j0, mopen: j0, minner: j0},
        mrel: {mord: q0, mop: q0, mopen: q0, minner: q0},
        mopen: {},
        mclose: {mop: J, mbin: j0, mrel: q0, minner: J},
        mpunct: {mord: J, mop: J, mrel: q0, mopen: J, mclose: J, mpunct: J, minner: J},
        minner: {mord: J, mop: J, mbin: j0, mrel: q0, mopen: J, mpunct: J, minner: J}
    }, Sa = {
        mord: {mop: J},
        mop: {mord: J, mop: J},
        mbin: {},
...
function Z0(r) {
    ...
    D({
        type: e, names: [], props: {numArgs: 0}, handler() {
            throw new Error("Should never be called.")
        }, htmlBuilder: t, mathmlBuilder: a
    })
}

d(Z0, "defineFunctionBuilders");
var Ue = d(function (e) {
        return e.type === "ordgroup" && e.body.length === 1 ? e.body[0] : e
    }, "normalizeArgument"), e0 = d(function (e) {
        return e.type === "ordgroup" ? e.body : [e]
    }, "ordargument"), za = new Set(["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"]),
    Aa = new Set(["rightmost", "mrel", "mclose", "mpunct"]),
    Ma = {display: O.DISPLAY, text: O.TEXT, script: O.SCRIPT, scriptscript: O.SCRIPTSCRIPT}, Ta = {
        mord: "mord",
        mop: "mop",
        mbin: "mbin",
        mrel: "mrel",
        ...
        if (e.length === 1) {
            var b = e[0];
            b.type === "sizing" ? p = t.havingSize(b.size) : b.type === "styling" && (p = t.havingStyle(Ma[b.style]))
        }
        var y = S([n[0] || "leftmost"], [], t), x = S([n[1] || "rightmost"], [], t), w = a === "root";
        return Mt(l, (T, B) => {
            var q = B.classes[0], R = T.classes[0];
            q === "mbin" && Aa.has(R) ? B.classes[0] = "mord" : R === "mbin" && za.has(q) && (T.classes[0] = "mord")
        }, {node: y}, x, w), Mt(l, (T, B) => {
            var q, R, N = Bt(B), H = Bt(T),
                L = N && H ? T.hasClass("mtight") ? (q = Sa[N]) == null ? void 0 : q[H] : (R = ka[N]) == null ? void 0 : R[H] : null;
            if (L) return Ur(L, p)
        }, {node: y}, x, w), l
    }, "buildExpression"), Mt = d(function (e, t, a, n, l) {
        n && e.push(n);
        for (var u = 0; u < e.length; u++) {
            var h = e[u], c = Wr(h);
            if (c) {
                Mt(c.children, t, a, null, l);
                continue
            }
            ...
            p ? a.node = h : l && h.hasClass("newline") && (a.node = S(["leftmost"])), a.insertAfter = (y => x => {
                e.splice(y + 1, 0, x), u++
            })(u)
        }
        n && e.pop()
    }, "traverseNonSpaceNodes"), Wr = d(function (e) {
        return e instanceof G0 || e instanceof ae || e instanceof V0 && e.hasClass("enclosing") ? e : null
    }, "checkPartialGroup"), Tt = d(function (e, t) {
        var a = Wr(e);
        if (a) {
            var n = a.children;
            if (n.length) {
                if (t === "right") return Tt(n[n.length - 1], "right");
                if (t === "left") return Tt(n[0], "left")
            }
        }
        return e
    }, "getOutermostNode"), Bt = d(function (e, t) {
        if (!e) return null;
        t && (e = Tt(e, t));
        var a = e.classes[0];
        return Ta[a] || null
    }, "getTypeOfDomTree"), pe = d(function (e, t) {
        var a = ["nulldelimiter"].concat(e.baseSizingClasses());
        return S(t.concat(a))
    }, "makeNullDelimiter"), V = d(function (e, t, a) {
        if (!e) return S();
        if (Pe[e.type]) {
            var n = Pe[e.type](e, t);
            if (a && t.size !== a.size) {
...
function Dt(r, e) {
    ...
    for (var l = [], u = [], h = 0; h < a.length; h++) if (u.push(a[h]), a[h].hasClass("mbin") || a[h].hasClass("mrel") || a[h].hasClass("allowbreak")) {
        ...
        c || (l.push(Re(u, e)), u = [])
    } else a[h].hasClass("newline") && (u.pop(), u.length > 0 && (l.push(Re(u, e)), u = []), l.push(a[h]));
    u.length > 0 && l.push(Re(u, e));
    var p;
    t ? (p = Re(n0(t, e, !0), e), p.classes = ["tag"], l.push(p)) : n && l.push(n);
    var b = S(["katex-html"], l);
    if (b.setAttribute("aria-hidden", "true"), p) {
        var y = p.children[0];
        y.style.height = M(b.height + b.depth), b.depth && (y.style.verticalAlign = M(-b.depth))
    }
    return b
}
...
var z = class {
    ...
    toMarkup() {
        ...
        this.classes.length > 0 && (e += ' class ="' + l0(U0(this.classes)) + '"'), e += ">";
        for (var a = 0; a < this.children.length; a++) e += this.children[a].toMarkup();
...
}, Ba = new Set(["\\imath", "\\jmath"]), Da = new Set(["mrow", "mtable"]), y0 = d(function (e, t, a) {
    return j[t][e] && j[t][e].replace && e.charCodeAt(0) !== 55349 && !(Pr.hasOwnProperty(e) && a && (a.fontFamily && a.fontFamily.slice(4, 6) === "tt" || a.font && a.font.slice(4, 6) === "tt")) && (e = j[t][e].replace), new _(e)
}, "makeText"), Gt = d(function (e) {
    return e.length === 1 ? e[0] : new z("mrow", e)
}, "makeRow"), Ut = d(function (e, t) {
...
d(ot, "isNumberPunctuation");
var g0 = d(function (e, t, a) {
    if (e.length === 1) {
        var n = W(e[0], t);
    ...
    for (var l = [], u, h = 0; h < e.length; h++) {
        ...
        if (c instanceof z && u instanceof z) {
            if (c.type === "mtext" && u.type === "mtext" && c.getAttribute("mathvariant") === u.getAttribute("mathvariant")) {
                ...
                u.children.push(...c.children);
                continue
            } else if (ot(c) && u.type === "mn") {
                u.children.push(...c.children);
                continue
            } else if (c.type === "mn" && ot(u)) c.children = [...u.children, ...c.children], l.pop(); else if ((c.type === "msup" || c.type === "msub") && c.children.length >= 1 && (u.type === "mn" || ot(u))) {
                var p = c.children[0];
                p instanceof z && p.type === "mn" && (p.children = [...u.children, ...p.children], l.pop())
            } else if (u.type === "mi" && u.children.length === 1) {
                var b = u.children[0];
                if (b instanceof _ && b.text === "\u0338" && (c.type === "mo" || c.type === "mi" || c.type === "mn")) {
                    var y = c.children[0];
                    y instanceof _ && y.text.length > 0 && (y.text = y.text.slice(0, 1) + "\u0338" + y.text.slice(1), l.pop())
                }
            }
        }
        l.push(c), u = c
    ...
    return l
}, "buildExpression"), Y0 = d(function (e, t, a) {
    return Gt(g0(e, t, a))
}, "buildExpressionRow"), W = d(function (e, t) {
...
function mr(r, e, t, a, n) {
    var l = g0(r, t), u;
    l.length === 1 && l[0] instanceof z && Da.has(l[0].type) ? u = l[0] : u = new z("mrow", l);
...
d(mr, "buildMathML");
var Ca = [[1, 1, 1], [2, 1, 1], [3, 1, 1], [4, 2, 1], [5, 2, 1], [6, 3, 1], [7, 4, 2], [8, 6, 3], [9, 7, 6], [10, 8, 7], [11, 10, 9]],
    cr = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488], dr = d(function (e, t) {
        return t.size < 2 ? e : Ca[e - 1][t.size - 1]
    }, "sizeAtStyle"), Xe = class r {
        static {
            d(this, "Options")
        }

        constructor(e) {
            this.style = e.style, this.color = e.color, this.size = e.size || r.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = cr[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0
        }
        ...
        fontMetrics() {
            return this._fontMetrics || (this._fontMetrics = fa(this.size)), this._fontMetrics
        }
...
Xe.BASESIZE = 6;
var jr = d(function (e) {
    return new Xe({style: e.displayMode ? O.DISPLAY : O.TEXT, maxSize: e.maxSize, minRuleThickness: e.minRuleThickness})
}, "optionsFromSettings"), Zr = d(function (e, t) {
    if (t.displayMode) {
        var a = ["katex-display"];
        t.leqno && a.push("leqno"), t.fleqn && a.push("fleqn"), e = S(a, [e])
    }
    return e
}, "displayWrap"), qa = d(function (e, t, a) {
    var n = jr(a), l;
    if (a.output === "mathml") return mr(e, t, n, a.displayMode, !0);
    if (a.output === "html") {
        var u = Dt(e, n);
        l = S(["katex"], [u])
    } else {
        var h = mr(e, t, n, a.displayMode, !1), c = Dt(e, n);
        l = S(["katex"], [h, c])
    }
    return Zr(l, a)
}, "buildTree"), Ra = d(function (e, t, a) {
    var n = jr(a), l = Dt(e, n), u = S(["katex"], [l]);
    return Zr(u, a)
}, "buildHTMLTree"), Ea = {
    widehat: "^",
    widecheck: "\u02C7",
    ...
    var t = new z("mo", [new _(Ea[e.replace(/^\\/, "")])]);
...
}, Na = new Set(["widehat", "widecheck", "widetilde", "utilde"]), Ke = d(function (e, t) {
    function a() {
        var h = 4e5, c = e.label.slice(1);
        if (Na.has(c)) {
            var p = e, b = p.base.type === "ordgroup" ? p.base.body.length : 1, y, x, w;
            if (b > 5) c === "widehat" || c === "widecheck" ? (y = 420, h = 2364, w = .42, x = c + "4") : (y = 312, h = 2340, w = .34, x = "tilde4"); else {
                var T = [1, 1, 2, 2, 3, 3][b];
                c === "widehat" || c === "widecheck" ? (h = [0, 1062, 2364, 2364, 2364][T], y = [0, 239, 300, 360, 420][T], w = [0, .24, .3, .3, .36, .42][T], x = c + T) : (h = [0, 600, 1033, 2339, 2340][T], y = [0, 260, 286, 306, 312][T], w = [0, .26, .286, .3, .306, .34][T], x = "tilde" + T)
            }
            var B = new M0(x), q = new k0([B], {
                width: "100%",
                height: M(w),
                viewBox: "0 0 " + h + " " + y,
                preserveAspectRatio: "none"
            });
            return {span: X0([], [q], t), minWidth: 0, height: w}
        } else {
            var R = [], N = Ia[c], [H, L, X] = N, P = X / 1e3, G = H.length, $, Y;
            if (G === 1) {
                var c0 = N[3];
                $ = ["hide-tail"], Y = [c0]
            } else if (G === 2) $ = ["halfarrow-left", "halfarrow-right"], Y = ["xMinYMin", "xMaxYMin"]; else if (G === 3) $ = ["brace-left", "brace-center", "brace-right"], Y = ["xMinYMin", "xMidYMin", "xMaxYMin"]; else throw new Error(`Correct katexImagesData or update code here to support
                    ` + G + " children.");
            for (var s0 = 0; s0 < G; s0++) {
                var r0 = new M0(H[s0]), $0 = new k0([r0], {
                    width: "400em",
                    height: M(P),
                    viewBox: "0 0 " + h + " " + X,
                    preserveAspectRatio: Y[s0] + " slice"
                }), d0 = X0([$[s0]], [$0], t);
                if (G === 1) return {span: d0, minWidth: L, height: P};
                d0.style.height = M(P), R.push(d0)
            }
            return {span: S(["stretchy"], R, t), minWidth: L, height: P}
        }
    }
...
}, "stretchySvg"), Oa = d(function (e, t, a, n, l) {
    ...
    if (/fbox|color|angl/.test(t)) {
        ...
        var p = [];
        /^[bx]cancel$/.test(t) && p.push(new ve({
            x1: "0",
            y1: "0",
            x2: "100%",
            y2: "100%",
            "stroke-width": "0.046em"
        })), /^x?cancel$/.test(t) && p.push(new ve({
            x1: "0",
            y1: "100%",
            x2: "100%",
            y2: "0",
        ...
        var b = new k0(p, {width: "100%", height: M(h)});
        u = X0([], [b], l)
    }
...
d(Je, "assertSymbolNodeType");

function Qe(r) {
    return r && (r.type === "atom" || pa.hasOwnProperty(r.type)) ? r : null
}

d(Qe, "checkSymbolNodeType");
var Kr = d(r => {
        if (r instanceof h0) return r;
        if (ca(r) && r.children.length === 1) return Kr(r.children[0])
    }, "getBaseSymbol"), Vt = d((r, e) => {
        var t, a, n;
        r && r.type === "supsub" ? (a = F(r.base, "accent"), t = a.base, r.base = t, n = ma(V(r, e)), r.base = a) : (a = F(r, "accent"), t = a.base);
        var l = V(t, e.havingCrampedStyle()), u = a.isShifty && E0(t), h = 0;
        if (u) {
            var c, p;
            h = (c = (p = Kr(l)) == null ? void 0 : p.skew) != null ? c : 0
        }
        var b = a.label === "\\c", y = b ? l.height + l.depth : Math.min(l.height, e.fontMetrics().xHeight), x;
        if (a.isStretchy) x = Ke(a, e), x = U({
            ...
            var w, T;
            a.label === "\\vec" ? (w = Xr("vec", e), T = Vr.vec[1]) : (w = je({
                type: "textord",
                mode: a.mode,
                text: a.label
            }, e, "textord"), w = ha(w), w.italic = 0, T = w.width, b && (y += w.depth)), x = S(["accent-body"], [w]);
            var B = a.label === "\\textcircled";
            B && (x.classes.push("accent-full"), y = l.height);
            var q = h;
            B || (q -= T / 2), x.style.left = M(q), a.label === "\\textcircled" && (x.style.top = ".2em"), x = U({
                positionType: "firstBaseline",
                children: [{type: "elem", elem: l}, {type: "kern", size: -y}, {type: "elem", elem: x}]
            })
        }
        var R = S(["mord", "accent"], [x], e);
        return n ? (n.children[0] = R, n.height = Math.max(R.height, n.height), n.classes[0] = "mord", n) : R
    }, "htmlBuilder$a"), Jr = d((r, e) => {
        var t = r.isStretchy ? Ze(r.label) : new z("mo", [y0(r.label, r.mode)]), a = new z("mover", [W(r.base, e), t]);
        return a.setAttribute("accent", "true"), a
    }, "mathmlBuilder$9"),
    Ha = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map(r => "\\" + r).join("|"));
D({
    type: "accent",
    names: ["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring", "\\widecheck", "\\widehat", "\\widetilde", "\\overrightarrow", "\\overleftarrow", "\\Overrightarrow", "\\overleftrightarrow", "\\overgroup", "\\overlinesegment", "\\overleftharpoon", "\\overrightharpoon"],
    props: {numArgs: 1},
    handler: d((r, e) => {
        var t = Ue(e[0]), a = !Ha.test(r.funcName),
...
D({
    ...
    htmlBuilder: d((r, e) => {
        var t = V(r.base, e), a = Ke(r, e), n = r.label === "\\utilde" ? .12 : 0, l = U({
            positionType: "top",
            positionData: t.height,
            children: [{type: "elem", elem: a, wrapperClasses: ["svg-align"]}, {type: "kern", size: n}, {
                type: "elem",
                elem: t
            }]
        });
    ...
    mathmlBuilder: d((r, e) => {
        var t = Ze(r.label), a = new z("munder", [W(r.base, e), t]);
...
D({
    ...
    htmlBuilder(r, e) {
        var t = e.style, a = e.havingStyle(t.sup()), n = ie(V(r.body, a, e), e),
            l = r.label.slice(0, 2) === "\\x" ? "x" : "cd";
        n.classes.push(l + "-arrow-pad");
        var u;
        r.below && (a = e.havingStyle(t.sub()), u = ie(V(r.below, a, e), e), u.classes.push(l + "-arrow-pad"));
        var h = Ke(r, e), c = -e.fontMetrics().axisHeight + .5 * h.height,
        ...
        if (u) {
            ...
            b = U({
                ...
                children: [{type: "elem", elem: n, shift: p}, {type: "elem", elem: h, shift: c}, {
                    type: "elem",
                    elem: u,
                    shift: y
                }]
        ...
        return b.children[0].children[0].children[1].classes.push("svg-align"), S(["mrel", "x-arrow"], [b], e)
    },
    mathmlBuilder(r, e) {
        var t = Ze(r.label);
        ...
        if (r.body) {
            var n = Ee(W(r.body, e));
            if (r.below) {
                var l = Ee(W(r.below, e));
                a = new z("munderover", [t, l, n])
            } else a = new z("mover", [t, n])
        } else if (r.below) {
            var u = Ee(W(r.below, e));
            a = new z("munder", [t, u])
        } else a = Ee(), a = new z("mover", [t, a]);
        return a
    }
});
...
D({
    ...
    handler(r, e) {
        var {parser: t, funcName: a} = r, n = e[0];
        return {type: "mclass", mode: t.mode, mclass: "m" + a.slice(5), body: e0(n), isCharacterBox: E0(n)}
    },
    htmlBuilder: Qr,
    mathmlBuilder: _r
});
...
D({
    type: "mclass", names: ["\\@binrel"], props: {numArgs: 2}, handler(r, e) {
        var {parser: t} = r;
        return {type: "mclass", mode: t.mode, mclass: _e(e[0]), body: e0(e[1]), isCharacterBox: E0(e[1])}
    }
});
D({
    type: "mclass", names: ["\\stackrel", "\\overset", "\\underset"], props: {numArgs: 2}, handler(r, e) {
        var {parser: t, funcName: a} = r, n = e[1], l = e[0], u;
        a !== "\\stackrel" ? u = _e(n) : u = "mrel";
        var h = {
            type: "op",
            mode: n.mode,
            limits: !0,
        ...
        return {type: "mclass", mode: t.mode, mclass: u, body: [c], isCharacterBox: E0(c)}
    }, htmlBuilder: Qr, mathmlBuilder: _r
});
D({
    type: "pmb", names: ["\\pmb"], props: {numArgs: 1, allowedInText: !0}, handler(r, e) {
        var {parser: t} = r;
        return {type: "pmb", mode: t.mode, mclass: _e(e[0]), body: e0(e[0])}
    }, htmlBuilder(r, e) {
        var t = n0(r.body, e, !0), a = S([r.mclass], t, e);
        return a.style.textShadow = "0.02em 0.01em 0.04px", a
    }, mathmlBuilder(r, e) {
        var t = g0(r.body, e), a = new z("mstyle", t);
...
var Fa = {
        ...
        "|": "\\Vert",
        ".": "no arrow"
    }, fr = d(() => ({type: "styling", body: [], mode: "math", style: "display"}), "newCell"),
    vr = d(r => r.type === "textord" && r.text === "@", "isStartOfArrow"),
    La = d((r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e, "isLabelEnd");
...
function Pa(r, e, t) {
    ...
    switch (a) {
        ...
        case"\\uparrow":
        case"\\downarrow": {
            var n = t.callFunction("\\\\cdleft", [e[0]], []), l = {type: "atom", text: a, mode: "math", family: "rel"},
                u = t.callFunction("\\Big", [l], []), h = t.callFunction("\\\\cdright", [e[1]], []),
...
function Ga(r) {
    ...
    for (r.gullet.beginGroup(), r.gullet.macros.set("\\cr", "\\\\\\relax"), r.gullet.beginGroup(); ;) {
        ...
        var t = r.fetch().text;
        if (t === "&" || t === "\\\\") r.consume(); else if (t === "\\end") {
            e[e.length - 1].length === 0 && e.pop();
            break
        } else throw new A("Expected \\\\ or \\cr or \\end", r.nextToken)
    }
    for (var a = [], n = [a], l = 0; l < e.length; l++) {
        for (var u = e[l], h = fr(), c = 0; c < u.length; c++) if (!vr(u[c])) h.body.push(u[c]); else {
            a.push(h), c += 1;
            var p = Je(u[c]).text, b = new Array(2);
            if (b[0] = {type: "ordgroup", mode: "math", body: []}, b[1] = {
                type: "ordgroup",
                mode: "math",
                body: []
            }, !"=|.".includes(p)) if ("<>AV".includes(p)) for (var y = 0; y < 2; y++) {
                for (var x = !0, w = c + 1; w < u.length; w++) {
                    if (La(u[w], p)) {
                        x = !1, c = w;
                        break
                    }
                    if (vr(u[w])) throw new A("Missing a " + p + " character to complete a CD arrow.", u[w]);
                    b[y].body.push(u[w])
                }
                if (x) throw new A("Missing a " + p + " character to complete a CD arrow.", u[c])
            } else throw new A('Expected one of "<>AV=|." after @', u[c]);
            var T = Pa(p, b, r), B = {type: "styling", body: [T], mode: "math", style: "display"};
            a.push(B), h = fr()
        }
        l % 2 === 0 ? a.push(h) : a.shift(), a = [], n.push(a)
    }
    r.gullet.endGroup(), r.gullet.endGroup();
    var q = new Array(n[0].length).fill({type: "align", align: "c", pregap: .25, postgap: .25});
    return {
        type: "array",
        mode: "math",
        body: n,
...
d(Ga, "parseCD");
D({
    type: "cdlabel", names: ["\\\\cdleft", "\\\\cdright"], props: {numArgs: 1}, handler(r, e) {
        var {parser: t, funcName: a} = r;
        return {type: "cdlabel", mode: t.mode, side: a.slice(4), label: e[0]}
    }, htmlBuilder(r, e) {
        var t = e.havingStyle(e.style.sup()), a = ie(V(r.label, t, e), e);
        return a.classes.push("cd-label-" + r.side), a.style.bottom = M(.8 - a.depth), a.height = 0, a.depth = 0, a
    }, mathmlBuilder(r, e) {
...
D({
    type: "cdlabelparent", names: ["\\\\cdparent"], props: {numArgs: 1}, handler(r, e) {
        var {parser: t} = r;
        return {type: "cdlabelparent", mode: t.mode, fragment: e[0]}
    }, htmlBuilder(r, e) {
        var t = ie(V(r.fragment, e), e);
...
D({
    type: "textord", names: ["\\@char"], props: {numArgs: 1, allowedInText: !0}, handler(r, e) {
        for (var {parser: t} = r, a = F(e[0], "ordgroup"), n = a.body, l = "", u = 0; u < n.length; u++) {
            var h = F(n[u], "textord");
            l += h.text
        }
        var c = parseInt(l), p;
        if (isNaN(c)) throw new A("\\@char has non-numeric argument " + l);
        if (c < 0 || c >= 1114111) throw new A("\\@char with invalid code point " + l);
...
var e1 = d((r, e) => {
    ...
    return N0(t)
}, "htmlBuilder$8"), t1 = d((r, e) => {
    var t = g0(r.body, e.withColor(r.color)), a = new z("mstyle", t);
...
D({
    type: "color", names: ["\\color"], props: {numArgs: 1, allowedInText: !0, argTypes: ["color"]}, handler(r, e) {
    ...
    }, htmlBuilder: e1, mathmlBuilder: t1
});
D({
    type: "cr", names: ["\\\\"], props: {numArgs: 0, numOptionalArgs: 0, allowedInText: !0}, handler(r, e, t) {
        var {parser: a} = r, n = a.gullet.future().text === "[" ? a.parseSizeGroup(!0) : null,
            l = !a.settings.displayMode || !a.settings.useStrictBehavior("newLineInDisplayMode", "In LaTeX, \\\\ or \\newline does nothing in display mode");
        return {type: "cr", mode: a.mode, newLine: l, size: n && F(n, "size").value}
    }, htmlBuilder(r, e) {
        var t = S(["mspace"], [], e);
        return r.newLine && (t.classes.push("newline"), r.size && (t.style.marginTop = M(Q(r.size, e)))), t
    }, mathmlBuilder(r, e) {
        var t = new z("mspace");
        return r.newLine && (t.setAttribute("linebreak", "newline"), r.size && t.setAttribute("height", M(Q(r.size, e)))), t
    }
});
var Ct = {
    "\\global": "\\global",
...
D({
    ...
    handler(r) {
        ...
        e.consumeSpaces();
        var a = e.fetch();
        if (Ct[a.text]) return (t === "\\global" || t === "\\\\globallong") && (a.text = Ct[a.text]), F(e.parseFunction(), "internal");
...
D({
    ...
    handler(r) {
        ...
        for (var l = 0, u, h = [[]]; e.gullet.future().text !== "{";) if (a = e.gullet.popToken(), a.text === "#") {
            ...
            if (parseInt(a.text) !== l + 1) throw new A('Argument number "' + a.text + '" out of order');
            l++, h.push([])
        } else {
        ...
        return u && c.unshift(u), (t === "\\edef" || t === "\\xdef") && (c = e.gullet.expandTokens(c), c.reverse()), e.gullet.macros.set(n, {
            ...
            numArgs: l,
            delimiters: h
        }, t === Ct[t]), {type: "internal", mode: e.mode}
    }
});
D({
    type: "internal",
    ...
    props: {numArgs: 0, allowedInText: !0, primitive: !0},
    handler(r) {
        var {parser: e, funcName: t} = r, a = r1(e.gullet.popToken());
        e.gullet.consumeSpaces();
        var n = Ua(e);
        return a1(e, a, n, t === "\\\\globallet"), {type: "internal", mode: e.mode}
    }
});
D({
    type: "internal",
    ...
    props: {numArgs: 0, allowedInText: !0, primitive: !0},
    handler(r) {
        var {parser: e, funcName: t} = r, a = r1(e.gullet.popToken()), n = e.gullet.popToken(), l = e.gullet.popToken();
        return a1(e, a, l, t === "\\\\globalfuture"), e.gullet.pushToken(l), e.gullet.pushToken(n), {
            type: "internal",
            mode: e.mode
        }
    }
});
var me = d(function (e, t, a) {
        var n = j.math[e] && j.math[e].replace, l = Ft(n || e, t, a);
        if (!l) throw new Error("Unsupported symbol " + e + " and font size " + t + ".");
        return l
    }, "getMetrics"), Xt = d(function (e, t, a, n) {
    ...
    }, "centerSpan"), Va = d(function (e, t, a, n, l, u) {
        var h = u0(e, "Main-Regular", l, n), c = Xt(h, t, n, u);
        return a && n1(c, n, t), c
    }, "makeSmallDelim"), Xa = d(function (e, t, a, n) {
        return u0(e, "Size" + t + "-Regular", a, n)
    }, "mathrmSize"), i1 = d(function (e, t, a, n, l, u) {
        var h = Xa(e, t, l, n), c = Xt(S(["delimsizing", "size" + t], [h], n), O.TEXT, n, u);
        return a && n1(c, n, O.TEXT), c
    }, "makeLargeDelim"), ht = d(function (e, t, a) {
        var n;
        t === "Size1-Regular" ? n = "delim-size1" : n = "delim-size4";
        var l = S(["delimsizinginner", n], [S([], [u0(e, t, a)])]);
        return {type: "elem", elem: l}
    }, "makeGlyphSpan"), mt = d(function (e, t, a) {
        var n = A0["Size4-Regular"][e.charCodeAt(0)] ? A0["Size4-Regular"][e.charCodeAt(0)][4] : A0["Size1-Regular"][e.charCodeAt(0)][4],
            l = new M0("inner", ia(e, Math.round(1e3 * t))), u = new k0([l], {
                width: M(n),
                height: M(t),
                style: "width:" + M(n),
    ...
    }, "makeInner"), qt = .008, Ie = {type: "kern", size: -1 * qt}, Ya = new Set(["|", "\\lvert", "\\rvert", "\\vert"]),
    Wa = new Set(["\\|", "\\lVert", "\\rVert", "\\Vert"]), l1 = d(function (e, t, a, n, l, u) {
        var h, c, p, b, y = "", x = 0;
        h = p = b = e, c = null;
        var w = "Size1-Regular";
        e === "\\uparrow" ? p = b = "\u23D0" : e === "\\Uparrow" ? p = b = "\u2016" : e === "\\downarrow" ? h = p = "\u23D0" : e === "\\Downarrow" ? h = p = "\u2016" : e === "\\updownarrow" ? (h = "\\uparrow", p = "\u23D0", b = "\\downarrow") : e === "\\Updownarrow" ? (h = "\\Uparrow", p = "\u2016", b = "\\Downarrow") : Ya.has(e) ? (p = "\u2223", y = "vert", x = 333) : Wa.has(e) ? (p = "\u2225", y = "doublevert", x = 556) : e === "[" || e === "\\lbrack" ? (h = "\u23A1", p = "\u23A2", b = "\u23A3", w = "Size4-Regular", y = "lbrack", x = 667) : e === "]" || e === "\\rbrack" ? (h = "\u23A4", p = "\u23A5", b = "\u23A6", w = "Size4-Regular", y = "rbrack", x = 667) : e === "\\lfloor" || e === "\u230A" ? (p = h = "\u23A2", b = "\u23A3", w = "Size4-Regular", y = "lfloor", x = 667) : e === "\\lceil" || e === "\u2308" ? (h = "\u23A1", p = b = "\u23A2", w = "Size4-Regular", y = "lceil", x = 667) : e === "\\rfloor" || e === "\u230B" ? (p = h = "\u23A5", b = "\u23A6", w = "Size4-Regular", y = "rfloor", x = 667) : e === "\\rceil" || e === "\u2309" ? (h = "\u23A4", p = b = "\u23A5", w = "Size4-Regular", y = "rceil", x = 667) : e === "(" || e === "\\lparen" ? (h = "\u239B", p = "\u239C", b = "\u239D", w = "Size4-Regular", y = "lparen", x = 875) : e === ")" || e === "\\rparen" ? (h = "\u239E", p = "\u239F", b = "\u23A0", w = "Size4-Regular", y = "rparen", x = 875) : e === "\\{" || e === "\\lbrace" ? (h = "\u23A7", c = "\u23A8", b = "\u23A9", p = "\u23AA", w = "Size4-Regular") : e === "\\}" || e === "\\rbrace" ? (h = "\u23AB", c = "\u23AC", b = "\u23AD", p = "\u23AA", w = "Size4-Regular") : e === "\\lgroup" || e === "\u27EE" ? (h = "\u23A7", b = "\u23A9", p = "\u23AA", w = "Size4-Regular") : e === "\\rgroup" || e === "\u27EF" ? (h = "\u23AB", b = "\u23AD", p = "\u23AA", w = "Size4-Regular") : e === "\\lmoustache" || e === "\u23B0" ? (h = "\u23A7", b = "\u23AD", p = "\u23AA", w = "Size4-Regular") : (e === "\\rmoustache" || e === "\u23B1") && (h = "\u23AB", b = "\u23A9", p = "\u23AA", w = "Size4-Regular");
        var T = me(h, w, l), B = T.height + T.depth, q = me(p, w, l), R = q.height + q.depth, N = me(b, w, l),
            H = N.height + N.depth, L = 0, X = 1;
        if (c !== null) {
            var P = me(c, w, l);
            L = P.height + P.depth, X = 2
        }
        var G = B + H + L, $ = Math.max(0, Math.ceil((t - G) / (X * R))), Y = G + $ * X * R,
            c0 = n.fontMetrics().axisHeight;
        a && (c0 *= n.sizeMultiplier);
        var s0 = Y / 2 - c0, r0 = [];
        if (y.length > 0) {
            var $0 = Y - B - H, d0 = Math.round(Y * 1e3), x0 = la(y, Math.round($0 * 1e3)), O0 = new M0(y, x0),
                K0 = M(x / 1e3), J0 = M(d0 / 1e3),
                nt = new k0([O0], {width: K0, height: J0, viewBox: "0 0 " + x + " " + d0}), H0 = X0([], [nt], n);
            H0.height = d0 / 1e3, H0.style.width = K0, H0.style.height = J0, r0.push({type: "elem", elem: H0})
        } else {
            if (r0.push(ht(b, w, l)), r0.push(Ie), c === null) {
                var F0 = Y - B - H + 2 * qt;
                r0.push(mt(p, F0, n))
            } else {
                var ue = (Y - B - H - L) / 2 + 2 * qt;
                r0.push(mt(p, ue, n)), r0.push(Ie), r0.push(ht(c, w, l)), r0.push(Ie), r0.push(mt(p, ue, n))
            }
            r0.push(Ie), r0.push(ht(h, w, l))
        }
        var w0 = n.havingBaseStyle(O.TEXT), ye = U({positionType: "bottom", positionData: s0, children: r0});
        return Xt(S(["delimsizing", "mult"], [ye], w0), O.TEXT, n, u)
    }, "makeStackedDelim"), ct = 80, dt = .08, ft = d(function (e, t, a, n, l) {
        var u = na(e, n, a), h = new M0(e, u), c = new k0([h], {
            width: "400em",
            height: M(t),
            viewBox: "0 0 400000 " + a,
            preserveAspectRatio: "xMinYMin slice"
        });
        return X0(["hide-tail"], [c], l)
    }, "sqrtSvg"), $a = d(function (e, t) {
        var a = t.havingBaseSizing(), n = m1("\\surd", e * a.sizeMultiplier, h1, a), l = a.sizeMultiplier,
            u = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), h, c = 0, p = 0, b = 0, y;
        return n.type === "small" ? (b = 1e3 + 1e3 * u + ct, e < 1 ? l = 1 : e < 1.4 && (l = .7), c = (1 + u + dt) / l, p = (1 + u) / l, h = ft("sqrtMain", c, b, u, t), h.style.minWidth = "0.853em", y = .833 / l) : n.type === "large" ? (b = (1e3 + ct) * ce[n.size], p = (ce[n.size] + u) / l, c = (ce[n.size] + u + dt) / l, h = ft("sqrtSize" + n.size, c, b, u, t), h.style.minWidth = "1.02em", y = 1 / l) : (c = e + u + dt, p = e + u, b = Math.floor(1e3 * e + u) + ct, h = ft("sqrtTall", c, b, u, t), h.style.minWidth = "0.742em", y = 1.056), h.height = p, h.style.height = M(c), {
            span: h,
            advanceWidth: y,
            ruleWidth: (t.fontMetrics().sqrtRuleThickness + u) * l
        }
    }, "makeSqrtImage"),
    s1 = new Set(["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\u230A", "\u230B", "\\lceil", "\\rceil", "\u2308", "\u2309", "\\surd"]),
    ja = new Set(["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27EE", "\u27EF", "\\lmoustache", "\\rmoustache", "\u23B0", "\u23B1"]),
    u1 = new Set(["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"]), ce = [0, 1.2, 1.8, 2.4, 3],
    o1 = d(function (e, t, a, n, l) {
        if (e === "<" || e === "\\lt" || e === "\u27E8" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "\u27E9") && (e = "\\rangle"), s1.has(e) || u1.has(e)) return i1(e, t, !1, a, n, l);
        if (ja.has(e)) return l1(e, ce[t], !1, a, n, l);
        throw new A("Illegal delimiter: '" + e + "'")
    }, "makeSizedDelim"), Za = [{type: "small", style: O.SCRIPTSCRIPT}, {type: "small", style: O.SCRIPT}, {
        type: "small",
        style: O.TEXT
    }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {type: "large", size: 4}],
    Ka = [{type: "small", style: O.SCRIPTSCRIPT}, {type: "small", style: O.SCRIPT}, {
        type: "small",
        style: O.TEXT
    }, {type: "stack"}], h1 = [{type: "small", style: O.SCRIPTSCRIPT}, {type: "small", style: O.SCRIPT}, {
        type: "small",
        style: O.TEXT
    }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {
        type: "large",
        size: 4
    }, {type: "stack"}], Ja = d(function (e) {
    ...
    }, "delimTypeToFont"), m1 = d(function (e, t, a, n) {
        for (var l = Math.min(2, 3 - n.style.size), u = l; u < a.length; u++) {
            var h = a[u];
            if (h.type === "stack") break;
            var c = me(e, Ja(h), "math"), p = c.height + c.depth;
            if (h.type === "small") {
                var b = n.havingBaseStyle(h.style);
                p *= b.sizeMultiplier
            }
            if (p > t) return h
        }
        return a[a.length - 1]
    }, "traverseSequence"), Rt = d(function (e, t, a, n, l, u) {
        e === "<" || e === "\\lt" || e === "\u27E8" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "\u27E9") && (e = "\\rangle");
        var h;
        u1.has(e) ? h = Za : s1.has(e) ? h = h1 : h = Ka;
        var c = m1(e, t, h, n);
        return c.type === "small" ? Va(e, c.style, a, n, l, u) : c.type === "large" ? i1(e, c.size, a, n, l, u) : l1(e, t, a, n, l, u)
    }, "makeCustomSizedDelim"), vt = d(function (e, t, a, n, l, u) {
        var h = n.fontMetrics().axisHeight * n.sizeMultiplier, c = 901, p = 5 / n.fontMetrics().ptPerEm,
            b = Math.max(t - h, a + h), y = Math.max(b / 500 * c, 2 * b - p);
        return Rt(e, y, !0, n, l, u)
    }, "makeLeftRightDelim"), pr = {
    ...
    Qa = new Set(["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\u230A", "\u230B", "\\lceil", "\\rceil", "\u2308", "\u2309", "<", ">", "\\langle", "\u27E8", "\\rangle", "\u27E9", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27EE", "\u27EF", "\\lmoustache", "\\rmoustache", "\u23B0", "\u23B1", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."]);

function et(r, e) {
    var t = Qe(r);
    if (t && Qa.has(t.text)) return t;
...
D({
    ...
    htmlBuilder: d((r, e) => r.delim === "." ? S([r.mclass]) : o1(r.delim, r.size, e, r.mode, [r.mclass]), "htmlBuilder"),
    mathmlBuilder: d(r => {
        var e = [];
...
d(gr, "assertParsed");
D({
    type: "leftright-right", names: ["\\right"], props: {numArgs: 1, primitive: !0}, handler: d((r, e) => {
        var t = r.parser.gullet.macros.get("\\current@color");
        if (t && typeof t != "string") throw new A("\\current@color set to non-string in \\right");
        return {type: "leftright-right", mode: r.parser.mode, delim: et(e[0], r).text, color: t}
    }, "handler")
});
D({
    type: "leftright", names: ["\\left"], props: {numArgs: 1, primitive: !0}, handler: d((r, e) => {
        var t = et(e[0], r), a = r.parser;
        ++a.leftrightDepth;
        var n = a.parseExpression(!1);
        --a.leftrightDepth, a.expect("\\right", !1);
        var l = F(a.parseFunction(), "leftright-right");
        return {type: "leftright", mode: a.mode, body: n, left: t.text, right: l.delim, rightColor: l.color}
    }, "handler"), htmlBuilder: d((r, e) => {
        gr(r);
        for (var t = n0(r.body, e, !0, ["mopen", "mclose"]), a = 0, n = 0, l = !1, u = 0; u < t.length; u++) t[u].isMiddle ? l = !0 : (a = Math.max(t[u].height, a), n = Math.max(t[u].depth, n));
        a *= e.sizeMultiplier, n *= e.sizeMultiplier;
        var h;
        if (r.left === "." ? h = pe(e, ["mopen"]) : h = vt(r.left, a, n, e, r.mode, ["mopen"]), t.unshift(h), l) for (var c = 1; c < t.length; c++) {
            var p = t[c], b = p.isMiddle;
            b && (t[c] = vt(b.delim, a, n, b.options, r.mode, []))
        }
        var y;
        if (r.right === ".") y = pe(e, ["mclose"]); else {
            var x = r.rightColor ? e.withColor(r.rightColor) : e;
            y = vt(r.right, a, n, x, r.mode, ["mclose"])
        }
        return t.push(y), S(["minner"], t, e)
    }, "htmlBuilder"), mathmlBuilder: d((r, e) => {
        gr(r);
        var t = g0(r.body, e);
        if (r.left !== ".") {
            var a = new z("mo", [y0(r.left, r.mode)]);
            a.setAttribute("fence", "true"), t.unshift(a)
        }
        if (r.right !== ".") {
            var n = new z("mo", [y0(r.right, r.mode)]);
...
D({
    type: "middle", names: ["\\middle"], props: {numArgs: 1, primitive: !0}, handler: d((r, e) => {
        var t = et(e[0], r);
        if (!r.parser.leftrightDepth) throw new A("\\middle without preceding \\left", t);
        return {type: "middle", mode: r.parser.mode, delim: t.text}
    }, "handler"), htmlBuilder: d((r, e) => {
        var t;
        if (r.delim === ".") t = pe(e, []); else {
            t = o1(r.delim, 1, e, r.mode, []);
            var a = {delim: r.delim, options: e};
            t.isMiddle = a
        }
        return t
    }, "htmlBuilder"), mathmlBuilder: d((r, e) => {
        var t = r.delim === "\\vert" || r.delim === "|" ? y0("|", "text") : y0(r.delim, r.mode), a = new z("mo", [t]);
        return a.setAttribute("fence", "true"), a.setAttribute("lspace", "0.05em"), a.setAttribute("rspace", "0.05em"), a
    }, "mathmlBuilder")
});
var tt = d((r, e) => {
    var t = ie(V(r.body, e), e), a = r.label.slice(1), n = e.sizeMultiplier, l, u = 0, h = E0(r.body);
    if (a === "sout") l = S(["stretchy", "sout"]), l.height = e.fontMetrics().defaultRuleThickness / n, u = -.5 * e.fontMetrics().xHeight; else if (a === "phase") {
        var c = Q({number: .6, unit: "pt"}, e), p = Q({number: .35, unit: "ex"}, e), b = e.havingBaseSizing();
        n = n / b.sizeMultiplier;
        var y = t.height + t.depth + c + p;
        t.style.paddingLeft = M(y / 2 + c);
        var x = Math.floor(1e3 * y * n), w = ra(x), T = new k0([new M0("phase", w)], {
            width: "400em",
            height: M(x / 1e3),
            viewBox: "0 0 400000 " + x,
            preserveAspectRatio: "xMinYMin slice"
        });
        l = X0(["hide-tail"], [T], e), l.style.height = M(y), u = t.depth + c + p
    } else {
        /cancel/.test(a) ? h || t.classes.push("cancel-pad") : a === "angl" ? t.classes.push("anglpad") : t.classes.push("boxpad");
        var B = 0, q = 0, R = 0;
        /box/.test(a) ? (R = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness), B = e.fontMetrics().fboxsep + (a === "colorbox" ? 0 : R), q = B) : a === "angl" ? (R = Math.max(e.fontMetrics().defaultRuleThickness, e.minRuleThickness), B = 4 * R, q = Math.max(0, .25 - t.depth)) : (B = h ? .2 : 0, q = B), l = Oa(t, a, B, q, e), /fbox|boxed|fcolorbox/.test(a) ? (l.style.borderStyle = "solid", l.style.borderWidth = M(R)) : a === "angl" && R !== .049 && (l.style.borderTopWidth = M(R), l.style.borderRightWidth = M(R)), u = t.depth + q, r.backgroundColor && (l.style.backgroundColor = r.backgroundColor, r.borderColor && (l.style.borderColor = r.borderColor))
    }
    var N;
    if (r.backgroundColor) N = U({
        positionType: "individualShift",
        children: [{type: "elem", elem: l, shift: u}, {type: "elem", elem: t, shift: 0}]
    }); else {
        var H = /cancel|phase/.test(a) ? ["svg-align"] : [];
        N = U({
            positionType: "individualShift",
            children: [{type: "elem", elem: t, shift: 0}, {type: "elem", elem: l, shift: u, wrapperClasses: H}]
        })
    }
    return /cancel/.test(a) && (N.height = t.height, N.depth = t.depth), /cancel/.test(a) && !h ? S(["mord", "cancel-lap"], [N], e) : S(["mord"], [N], e)
}, "htmlBuilder$7"), rt = d((r, e) => {
    var t = 0, a = new z(r.label.includes("colorbox") ? "mpadded" : "menclose", [W(r.body, e)]);
    switch (r.label) {
        case"\\cancel":
...
D({
    ...
    handler(r, e, t) {
        var {parser: a, funcName: n} = r, l = F(e[0], "color-token").color, u = e[1];
...
D({
    ...
    handler(r, e, t) {
        var {parser: a, funcName: n} = r, l = F(e[0], "color-token").color, u = F(e[1], "color-token").color, h = e[2];
...
D({
    type: "enclose", names: ["\\fbox"], props: {numArgs: 1, argTypes: ["hbox"], allowedInText: !0}, handler(r, e) {
        var {parser: t} = r;
        return {type: "enclose", mode: t.mode, label: "\\fbox", body: e[0]}
    }
});
D({
    type: "enclose", names: ["\\cancel", "\\bcancel", "\\xcancel", "\\phase"], props: {numArgs: 1}, handler(r, e) {
        var {parser: t, funcName: a} = r, n = e[0];
        return {type: "enclose", mode: t.mode, label: a, body: n}
    }, htmlBuilder: tt, mathmlBuilder: rt
});
D({
    type: "enclose", names: ["\\sout"], props: {numArgs: 1, allowedInText: !0}, handler(r, e) {
        var {parser: t, funcName: a} = r;
...
D({
    type: "enclose", names: ["\\angl"], props: {numArgs: 1, argTypes: ["hbox"], allowedInText: !1}, handler(r, e) {
        var {parser: t} = r;
...
function T0(r) {
    for (var {type: e, names: t, props: a, handler: n, htmlBuilder: l, mathmlBuilder: u} = r, h = {
        ...
        numOptionalArgs: 0,
        handler: n
    }, c = 0; c < t.length; ++c) c1[t[c]] = h;
    l && (Pe[e] = l), u && (Ge[e] = u)
}

d(T0, "defineEnvironment");
var d1 = {};
...
var f0 = class r {
    ...
    range(e, t) {
        return new r(t, f0.range(this, e))
    }
};
...
}, "validateAmsEnvironmentContext"), _a = new Set(["gather", "gather*"]);
...
function W0(r, e, t) {
    ...
    if (r.gullet.beginGroup(), p || r.gullet.macros.set("\\cr", "\\\\\\relax"), !u) {
        ...
        if (w == null) u = 1; else if (u = parseFloat(w), !u || u < 0) throw new A("Invalid \\arraystretch: " + w)
    }
    r.gullet.beginGroup();
    var T = [], B = [T], q = [], R = [], N = c != null ? [] : void 0;
    ...
    function L() {
        N && (r.gullet.macros.get("\\df@tag") ? (N.push(r.subparse([new v0("\\df@tag")])), r.gullet.macros.set("\\df@tag", void 0, !0)) : N.push(!!c && r.gullet.macros.get("\\@eqnsw") === "1"))
    }

    for (d(L, "endRow"), H(), R.push(br(r)); ;) {
        var X = r.parseExpression(!1, p ? "\\end" : "\\\\");
        r.gullet.endGroup(), r.gullet.beginGroup();
        var P = {type: "ordgroup", mode: r.mode, body: X};
        t && (P = {type: "styling", mode: r.mode, style: t, body: [P]}), T.push(P);
        var G = r.fetch().text;
        if (G === "&") {
            if (y && T.length === y) {
                if (p || h) throw new A("Too many tab characters: &", r.nextToken);
                r.settings.reportNonstrict("textEnv", "Too few columns specified in the {array} column argument.")
            }
            r.consume()
        } else if (G === "\\end") {
            L(), T.length === 1 && P.type === "styling" && P.body.length === 1 && P.body[0].type === "ordgroup" && P.body[0].body.length === 0 && (B.length > 1 || !b) && B.pop(), R.length < B.length + 1 && R.push([]);
            break
        } else if (G === "\\\\") {
            r.consume();
            var $ = void 0;
            r.gullet.future().text !== " " && ($ = r.parseSizeGroup(!0)), q.push($ ? $.value : null), L(), R.push(br(r)), T = [], B.push(T), H()
...
d(Wt, "dCellStyle");
var B0 = d(function (e, t) {
    var a, n, l = e.body.length, u = e.hLinesBeforeRow, h = 0, c = new Array(l), p = [],
        b = Math.max(t.fontMetrics().arrayRuleWidth, t.minRuleThickness), y = 1 / t.fontMetrics().ptPerEm, x = 5 * y;
    if (e.colSeparationType && e.colSeparationType === "small") {
        var w = t.havingStyle(O.SCRIPT).sizeMultiplier;
        x = .2778 * (w / t.sizeMultiplier)
    }
    var T = e.colSeparationType === "CD" ? Q({number: 3, unit: "ex"}, t) : 12 * y, B = 3 * y, q = e.arraystretch * T,
        R = .7 * q, N = .3 * q, H = 0;

    function L(Se) {
        for (var ze = 0; ze < Se.length; ++ze) ze > 0 && (H += .25), p.push({pos: H, isDashed: Se[ze]})
    }

    for (d(L, "setHLinePos"), L(u[0]), a = 0; a < e.body.length; ++a) {
        var X = e.body[a], P = R, G = N;
        h < X.length && (h = X.length);
        var $ = new Array(X.length);
        for (n = 0; n < X.length; ++n) {
            var Y = V(X[n], t);
            G < Y.depth && (G = Y.depth), P < Y.height && (P = Y.height), $[n] = Y
        }
        var c0 = e.rowGaps[a], s0 = 0;
        c0 && (s0 = Q(c0, t), s0 > 0 && (s0 += N, G < s0 && (G = s0), s0 = 0)), e.addJot && a < e.body.length - 1 && (G += B), $.height = P, $.depth = G, H += P, $.pos = H, H += G + s0, c[a] = $, L(u[a + 1])
    }
    var r0 = H / 2 + t.fontMetrics().axisHeight, $0 = e.cols || [], d0 = [], x0, O0, K0 = [];
    if (e.tags && e.tags.some(Se => Se)) for (a = 0; a < l; ++a) {
        var J0 = c[a], nt = J0.pos - r0, H0 = e.tags[a], F0 = void 0;
        H0 === !0 ? F0 = S(["eqn-num"], [], t) : H0 === !1 ? F0 = S([], [], t) : F0 = S([], n0(H0, t, !0), t), F0.depth = J0.depth, F0.height = J0.height, K0.push({
            type: "elem",
            elem: F0,
            shift: nt
        })
    }
    for (n = 0, O0 = 0; n < h || O0 < $0.length; ++n, ++O0) {
        for (var ue, w0 = $0[O0], ye = !0; ((Jt = w0) == null ? void 0 : Jt.type) === "separator";) {
            var Jt;
            if (ye || (x0 = S(["arraycolsep"], []), x0.style.width = M(t.fontMetrics().doubleRuleSep), d0.push(x0)), w0.separator === "|" || w0.separator === ":") {
                var C1 = w0.separator === "|" ? "solid" : "dashed", Q0 = S(["vertical-separator"], [], t);
                Q0.style.height = M(H), Q0.style.borderRightWidth = M(b), Q0.style.borderRightStyle = C1, Q0.style.margin = "0 " + M(-b / 2);
                var Qt = H - r0;
                Qt && (Q0.style.verticalAlign = M(-Qt)), d0.push(Q0)
            } else throw new A("Invalid separator type: " + w0.separator);
            O0++, w0 = $0[O0], ye = !1
        }
        if (!(n >= h)) {
            var _0 = void 0;
            if (n > 0 || e.hskipBeforeAndAfter) {
                var _t, er;
                _0 = (_t = (er = w0) == null ? void 0 : er.pregap) != null ? _t : x, _0 !== 0 && (x0 = S(["arraycolsep"], []), x0.style.width = M(_0), d0.push(x0))
            }
            var tr = [];
            for (a = 0; a < l; ++a) {
                var xe = c[a], we = xe[n];
                if (we) {
                    var q1 = xe.pos - r0;
                    we.depth = xe.depth, we.height = xe.height, tr.push({type: "elem", elem: we, shift: q1})
                }
            }
            var R1 = U({positionType: "individualShift", children: tr}),
                E1 = S(["col-align-" + (((ue = w0) == null ? void 0 : ue.align) || "c")], [R1]);
            if (d0.push(E1), n < h - 1 || e.hskipBeforeAndAfter) {
                var rr, ar;
                _0 = (rr = (ar = w0) == null ? void 0 : ar.postgap) != null ? rr : x, _0 !== 0 && (x0 = S(["arraycolsep"], []), x0.style.width = M(_0), d0.push(x0))
            }
        }
    }
    var ke = S(["mtable"], d0);
    if (p.length > 0) {
        for (var I1 = ne("hline", t, b), N1 = ne("hdashline", t, b), it = [{
            type: "elem",
            elem: ke,
            shift: 0
        }]; p.length > 0;) {
            var nr = p.pop(), ir = nr.pos - r0;
            nr.isDashed ? it.push({type: "elem", elem: N1, shift: ir}) : it.push({type: "elem", elem: I1, shift: ir})
        }
        ke = U({positionType: "individualShift", children: it})
    }
    if (K0.length === 0) return S(["mord"], [ke], t);
    var O1 = U({positionType: "individualShift", children: K0}), H1 = S(["tag"], [O1], t);
    return N0([ke, H1])
}, "htmlBuilder"), e4 = {c: "center ", l: "left ", r: "right "}, D0 = d(function (e, t) {
    for (var a = [], n = new z("mtd", [], ["mtr-glue"]), l = new z("mtd", [], ["mml-eqn-num"]), u = 0; u < e.body.length; u++) {
        for (var h = e.body[u], c = [], p = 0; p < h.length; p++) c.push(new z("mtd", [W(h[p], t)]));
        e.tags && e.tags[u] && (c.unshift(n), c.push(n), e.leqno ? c.unshift(l) : c.push(l)), a.push(new z("mtr", c))
    }
    var b = new z("mtable", a), y = e.arraystretch === .5 ? .1 : .16 + e.arraystretch - 1 + (e.addJot ? .09 : 0);
    b.setAttribute("rowspacing", M(y));
    var x = "", w = "";
    if (e.cols && e.cols.length > 0) {
        var T = e.cols, B = "", q = !1, R = 0, N = T.length;
        T[0].type === "separator" && (x += "top ", R = 1), T[T.length - 1].type === "separator" && (x += "bottom ", N -= 1);
        for (var H = R; H < N; H++) {
            var L = T[H];
            L.type === "align" ? (w += e4[L.align], q && (B += "none "), q = !0) : L.type === "separator" && q && (B += L.separator === "|" ? "solid " : "dashed ", q = !1)
        }
        b.setAttribute("columnalign", w.trim()), /[sd]/.test(B) && b.setAttribute("columnlines", B.trim())
    }
    if (e.colSeparationType === "align") {
        for (var X = e.cols || [], P = "", G = 1; G < X.length; G++) P += G % 2 ? "0em " : "1em ";
    ...
    var $ = "", Y = e.hLinesBeforeRow;
    x += Y[0].length > 0 ? "left " : "", x += Y[Y.length - 1].length > 0 ? "right " : "";
    for (var c0 = 1; c0 < Y.length - 1; c0++) $ += Y[c0].length === 0 ? "none " : Y[c0][0] ? "dashed " : "solid ";
    return /[sd]/.test($) && b.setAttribute("rowlines", $.trim()), x !== "" && (b = new z("menclose", [b]), b.setAttribute("notation", x.trim())), e.arraystretch && e.arraystretch < 1 && (b = new z("mstyle", [b]), b.setAttribute("scriptlevel", "1")), b
}, "mathmlBuilder"), f1 = d(function (e, t) {
    e.envName.includes("ed") || at(e);
    var a = [], n = e.envName.includes("at") ? "alignat" : "align", l = e.envName === "split", u = W0(e.parser, {
        cols: a,
        addJot: !0,
        autoTag: l ? void 0 : Yt(e.envName),
        emptySingleRow: !0,
        colSeparationType: n,
        maxNumCols: l ? 2 : void 0,
        leqno: e.parser.settings.leqno
    }, "display"), h = 0, c = 0, p = {type: "ordgroup", mode: e.mode, body: []};
    if (t[0] && t[0].type === "ordgroup") {
        for (var b = "", y = 0; y < t[0].body.length; y++) {
            var x = F(t[0].body[y], "textord");
            b += x.text
        }
        h = Number(b), c = h * 2
    }
    var w = !c;
    u.body.forEach(function (R) {
        for (var N = 1; N < R.length; N += 2) {
            var H = F(R[N], "styling"), L = F(H.body[0], "ordgroup");
            L.body.unshift(p)
        }
        if (w) c < R.length && (c = R.length); else {
            var X = R.length / 2;
            if (h < X) throw new A("Too many math in a row: " + ("expected " + h + ", but got " + X), R[0])
        }
    });
    for (var T = 0; T < c; ++T) {
        var B = "r", q = 0;
        T % 2 === 1 ? B = "l" : T > 0 && w && (q = 1), a[T] = {type: "align", align: B, pregap: q, postgap: 0}
    }
    return u.colSeparationType = w ? "align" : "alignat", u
}, "alignedHandler");
T0({
    type: "array", names: ["array", "darray"], props: {numArgs: 1}, handler(r, e) {
        var t = Qe(e[0]), a = t ? [e[0]] : F(e[0], "ordgroup").body, n = a.map(function (u) {
            var h = Je(u), c = h.text;
        ...
        return W0(r.parser, l, Wt(r.envName))
    }, htmlBuilder: B0, mathmlBuilder: D0
});
T0({
    type: "array",
    ...
    handler(r) {
        var e = {
            ...
            vmatrix: ["|", "|"],
            Vmatrix: ["\\Vert", "\\Vert"]
        }[r.envName.replace("*", "")], t = "c", a = {hskipBeforeAndAfter: !1, cols: [{type: "align", align: t}]};
        if (r.envName.charAt(r.envName.length - 1) === "*") {
            var n = r.parser;
            if (n.consumeSpaces(), n.fetch().text === "[") {
                if (n.consume(), n.consumeSpaces(), t = n.fetch().text, !"lcr".includes(t)) throw new A("Expected l or c or r", n.nextToken);
                n.consume(), n.consumeSpaces(), n.expect("]"), n.consume(), a.cols = [{type: "align", align: t}]
            }
        }
        var l = W0(r.parser, a, Wt(r.envName)), u = Math.max(0, ...l.body.map(h => h.length));
        return l.cols = new Array(u).fill({type: "align", align: t}), e ? {
            type: "leftright",
            mode: r.mode,
            body: [l],
            left: e[0],
...
T0({
    type: "array", names: ["smallmatrix"], props: {numArgs: 0}, handler(r) {
        var e = {arraystretch: .5}, t = W0(r.parser, e, "script");
        return t.colSeparationType = "small", t
    }, htmlBuilder: B0, mathmlBuilder: D0
});
T0({
    type: "array", names: ["subarray"], props: {numArgs: 1}, handler(r, e) {
        var t = Qe(e[0]), a = t ? [e[0]] : F(e[0], "ordgroup").body, n = a.map(function (h) {
            var c = Je(h), p = c.text;
            if ("lc".includes(p)) return {type: "align", align: p};
            throw new A("Unknown column alignment: " + p, h)
        });
        if (n.length > 1) throw new A("{subarray} can contain only one column");
        var l = {cols: n, hskipBeforeAndAfter: !1, arraystretch: .5}, u = W0(r.parser, l, "script");
        if (u.body.length > 0 && u.body[0].length > 1) throw new A("{subarray} can contain only one column");
        return u
    }, htmlBuilder: B0, mathmlBuilder: D0
});
T0({
    type: "array", names: ["cases", "dcases", "rcases", "drcases"], props: {numArgs: 0}, handler(r) {
        var e = {
            arraystretch: 1.2,
...
T0({
    type: "array", names: ["gathered", "gather", "gather*"], props: {numArgs: 0}, handler(r) {
        _a.has(r.envName) && at(r);
        var e = {
            cols: [{type: "align", align: "c"}],
            addJot: !0,
            colSeparationType: "gather",
            autoTag: Yt(r.envName),
            emptySingleRow: !0,
...
T0({
    type: "array", names: ["equation", "equation*"], props: {numArgs: 0}, handler(r) {
        at(r);
        var e = {
            autoTag: Yt(r.envName),
            emptySingleRow: !0,
...
T0({
    type: "array", names: ["CD"], props: {numArgs: 0}, handler(r) {
        return at(r), Ga(r.parser)
    }, htmlBuilder: B0, mathmlBuilder: D0
});
...
var yr = c1;
D({
    type: "environment", names: ["\\begin", "\\end"], props: {numArgs: 1, argTypes: ["text"]}, handler(r, e) {
        var {parser: t, funcName: a} = r, n = e[0];
        if (n.type !== "ordgroup") throw new A("Invalid environment name", n);
        for (var l = "", u = 0; u < n.body.length; ++u) l += F(n.body[u], "textord").text;
        if (a === "\\begin") {
            if (!yr.hasOwnProperty(l)) throw new A("No such environment: " + l, n);
            var h = yr[l], {args: c, optArgs: p} = t.parseArguments("\\begin{" + l + "}", h),
                b = {mode: t.mode, envName: l, parser: t}, y = h.handler(b, c, p);
            t.expect("\\end", !1);
            var x = t.nextToken, w = F(t.parseFunction(), "environment");
            if (w.name !== l) throw new A("Mismatch: \\begin{" + l + "} matched by \\end{" + w.name + "}", x);
            return y
        }
...
var v1 = d((r, e) => {
    ...
    return V(r.body, a)
}, "htmlBuilder$5"), p1 = d((r, e) => {
    var t = r.font, a = e.withFont(t);
    return W(r.body, a)
}, "mathmlBuilder$4"), xr = {"\\Bbb": "\\mathbb", "\\bold": "\\mathbf", "\\frak": "\\mathfrak", "\\bm": "\\boldsymbol"};
D({
    type: "font",
    ...
    handler: d((r, e) => {
        var {parser: t, funcName: a} = r, n = Ue(e[0]), l = a;
        return l in xr && (l = xr[l]), {type: "font", mode: t.mode, font: l.slice(1), body: n}
    }, "handler"),
    htmlBuilder: v1,
    mathmlBuilder: p1
});
D({
    type: "mclass", names: ["\\boldsymbol", "\\bm"], props: {numArgs: 1}, handler: d((r, e) => {
...
D({
    ...
    props: {numArgs: 0, allowedInText: !0},
    handler: d((r, e) => {
        var {parser: t, funcName: a, breakOnTokenText: n} = r, {mode: l} = t, u = t.parseExpression(!0, n),
            h = "math" + a.slice(1);
...
var t4 = d((r, e) => {
    ...
    l = e.havingStyle(n);
    var p = V(r.denom, l, e), b, y, x;
    r.hasBarLine ? (r.barSize ? (y = Q(r.barSize, e), b = ne("frac-line", e, y)) : b = ne("frac-line", e), y = b.height, x = b.height) : (b = null, y = 0, x = e.fontMetrics().defaultRuleThickness);
    var w, T, B;
    t.size === O.DISPLAY.size ? (w = e.fontMetrics().num1, y > 0 ? T = 3 * x : T = 7 * x, B = e.fontMetrics().denom1) : (y > 0 ? (w = e.fontMetrics().num2, T = x) : (w = e.fontMetrics().num3, T = 3 * x), B = e.fontMetrics().denom2);
    var q;
    if (b) {
        var N = e.fontMetrics().axisHeight;
        w - u.depth - (N + .5 * y) < T && (w += T - (w - u.depth - (N + .5 * y))), N - .5 * y - (p.height - B) < T && (B += T - (N - .5 * y - (p.height - B)));
        var H = -(N - .5 * y);
        q = U({
            positionType: "individualShift",
            children: [{type: "elem", elem: p, shift: B}, {type: "elem", elem: b, shift: H}, {
                type: "elem",
                elem: u,
                shift: -w
            }]
        ...
        var R = w - u.depth - (p.height - B);
        R < T && (w += .5 * (T - R), B += .5 * (T - R)), q = U({
            positionType: "individualShift",
            children: [{type: "elem", elem: p, shift: B}, {type: "elem", elem: u, shift: -w}]
        })
    }
    l = e.havingStyle(t), q.height *= l.sizeMultiplier / e.sizeMultiplier, q.depth *= l.sizeMultiplier / e.sizeMultiplier;
    var L;
    t.size === O.DISPLAY.size ? L = e.fontMetrics().delim1 : t.size === O.SCRIPTSCRIPT.size ? L = e.havingStyle(O.SCRIPT).fontMetrics().delim2 : L = e.fontMetrics().delim2;
    var X, P;
    return r.leftDelim == null ? X = pe(e, ["mopen"]) : X = Rt(r.leftDelim, L, !0, e.havingStyle(t), r.mode, ["mopen"]), r.continued ? P = S([]) : r.rightDelim == null ? P = pe(e, ["mclose"]) : P = Rt(r.rightDelim, L, !0, e.havingStyle(t), r.mode, ["mclose"]), S(["mord"].concat(l.sizingClasses(e)), [X, S(["mfrac"], [q]), P], e)
}, "htmlBuilder$4"), r4 = d((r, e) => {
    var t = new z("mfrac", [W(r.numer, e), W(r.denom, e)]);
    if (!r.hasBarLine) t.setAttribute("linethickness", "0px"); else if (r.barSize) {
        var a = Q(r.barSize, e);
...
D({
    ...
    handler: d((r, e) => {
        ...
        return p || a.startsWith("\\d") ? b = "display" : a.startsWith("\\t") && (b = "text"), g1({
            type: "genfrac",
            mode: t.mode,
            numer: n,
            denom: l,
...
var wr = ["display", "text", "script", "scriptscript"], kr = d(function (e) {
    var t = null;
...
D({
    ...
    handler(r, e) {
        var {parser: t} = r, a = e[4], n = e[5], l = Ue(e[0]),
            u = l.type === "atom" && l.family === "open" ? kr(l.text) : null, h = Ue(e[1]),
            c = h.type === "atom" && h.family === "close" ? kr(h.text) : null, p = F(e[2], "size"), b, y = null;
        p.isBlank ? b = !0 : (y = p.value, b = y.number > 0);
        var x = null, w = e[3];
        if (w.type === "ordgroup") {
            if (w.body.length > 0) {
                var T = F(w.body[0], "textord");
                x = wr[Number(T.text)]
            }
        } else w = F(w, "textord"), x = wr[Number(w.text)];
        return g1({
            type: "genfrac",
            mode: t.mode,
            numer: a,
...
D({
    type: "infix", names: ["\\above"], props: {numArgs: 1, argTypes: ["size"], infix: !0}, handler(r, e) {
...
D({
    ...
    handler: d((r, e) => {
        var {parser: t, funcName: a} = r, n = e[0], l = F(e[1], "infix").size;
...
var b1 = d((r, e) => {
    ...
    var l = V(n.base, e.havingBaseStyle(O.DISPLAY)), u = Ke(n, e), h;
    if (n.isOver ? (h = U({
        positionType: "firstBaseline",
        children: [{type: "elem", elem: l}, {type: "kern", size: .1}, {type: "elem", elem: u}]
    }), h.children[0].children[0].children[1].classes.push("svg-align")) : (h = U({
        positionType: "bottom",
        positionData: l.depth + .1 + u.height,
        children: [{type: "elem", elem: u}, {type: "kern", size: .1}, {type: "elem", elem: l}]
    }), h.children[0].children[0].children[0].classes.push("svg-align")), a) {
        var c = S(["minner", n.isOver ? "mover" : "munder"], [h], e);
        n.isOver ? h = U({
            positionType: "firstBaseline",
            children: [{type: "elem", elem: c}, {type: "kern", size: .2}, {type: "elem", elem: a}]
        }) : h = U({
            positionType: "bottom",
            positionData: c.depth + .2 + a.height + a.depth,
            children: [{type: "elem", elem: a}, {type: "kern", size: .2}, {type: "elem", elem: c}]
        })
    }
    return S(["minner", n.isOver ? "mover" : "munder"], [h], e)
}, "htmlBuilder$3"), a4 = d((r, e) => {
    var t = Ze(r.label);
...
D({
    type: "href", names: ["\\url"], props: {numArgs: 1, argTypes: ["url"], allowedInText: !0}, handler: d((r, e) => {
        ...
        return {type: "href", mode: t.mode, href: a, body: e0(h)}
    }, "handler")
});
D({
    type: "hbox",
...
D({
    ...
    handler: d((r, e) => {
        var {parser: t, funcName: a, token: n} = r, l = F(e[0], "raw").string, u = e[1];
        ...
        switch (a) {
            ...
            case"\\htmlStyle":
                ...
                break;
            case"\\htmlData": {
                for (var p = l.split(","), b = 0; b < p.length; b++) {
                    var y = p[b], x = y.indexOf("=");
                    if (x < 0) throw new A("\\htmlData key/value '" + y + "' missing equals sign");
                    var w = y.slice(0, x), T = y.slice(x + 1);
                    c["data-" + w.trim()] = T
                }
    ...
    mathmlBuilder: d((r, e) => Y0(r.body, e), "mathmlBuilder")
});
D({
    type: "htmlmathml",
    names: ["\\html@mathml"],
    ...
    mathmlBuilder: d((r, e) => Y0(r.mathml, e), "mathmlBuilder")
});
var pt = d(function (e) {
    ...
    if (!Or(a)) throw new A("Invalid unit: '" + a.unit + "' in \\includegraphics.");
    return a
}, "sizeData");
D({
    ...
    handler: d((r, e, t) => {
        var {parser: a} = r, n = {number: 0, unit: "em"}, l = {number: .9, unit: "em"}, u = {number: 0, unit: "em"},
            h = "";
        if (t[0]) for (var c = F(t[0], "raw").string, p = c.split(","), b = 0; b < p.length; b++) {
            var y = p[b].split("=");
            if (y.length === 2) {
                var x = y[1].trim();
                switch (y[0].trim()) {
    ...
    mathmlBuilder: d((r, e) => {
        ...
        if (r.totalheight.number > 0 && (n = Q(r.totalheight, e) - a, t.setAttribute("valign", M(-n))), t.setAttribute("height", M(a + n)), r.width.number > 0) {
            var l = Q(r.width, e);
...
D({
    ...
    htmlBuilder: d((r, e) => {
        var t;
        r.alignment === "clap" ? (t = S([], [V(r.body, e)]), t = S(["inner"], [t], e)) : t = S(["inner"], [V(r.body, e)]);
...
D({
    type: "styling", names: ["\\(", "$"], props: {numArgs: 0, allowedInText: !0, allowedInMath: !1}, handler(r, e) {
...
D({
    type: "text", names: ["\\)", "\\]"], props: {numArgs: 0, allowedInText: !0, allowedInMath: !1}, handler(r, e) {
...
D({
    type: "mathchoice", names: ["\\mathchoice"], props: {numArgs: 4, primitive: !0}, handler: d((r, e) => {
        var {parser: t} = r;
        return {
            type: "mathchoice",
            mode: t.mode,
...
var y1 = d((r, e, t, a, n, l, u) => {
    r = S([], [r]);
    var h = t && E0(t), c, p;
    if (e) {
        var b = V(e, a.havingStyle(n.sup()), a);
        p = {elem: b, kern: Math.max(a.fontMetrics().bigOpSpacing1, a.fontMetrics().bigOpSpacing3 - b.depth)}
    }
    if (t) {
        var y = V(t, a.havingStyle(n.sub()), a);
    ...
    if (p && c) {
        ...
        x = U({
            ...
            children: [{type: "kern", size: a.fontMetrics().bigOpSpacing5}, {
                ...
                elem: c.elem,
                marginLeft: M(-l)
            }, {type: "kern", size: c.kern}, {type: "elem", elem: r}, {type: "kern", size: p.kern}, {
                type: "elem",
                elem: p.elem,
                marginLeft: M(l)
        ...
        x = U({
            ...
            children: [{type: "kern", size: a.fontMetrics().bigOpSpacing5}, {
                ...
                elem: c.elem,
                marginLeft: M(-l)
            }, {type: "kern", size: c.kern}, {type: "elem", elem: r}]
        })
    } else if (p) {
        var B = r.depth + u;
        x = U({
            positionType: "bottom",
            positionData: B,
            children: [{type: "elem", elem: r}, {type: "kern", size: p.kern}, {
                type: "elem",
                elem: p.elem,
                marginLeft: M(l)
            }, {type: "kern", size: a.fontMetrics().bigOpSpacing5}]
    ...
    if (c && l !== 0 && !h) {
        var R = S(["mspace"], [], a);
        R.style.marginRight = M(l), q.unshift(R)
    }
    return S(["mop", "op-limits"], q, a)
}, "assembleSupSub"), x1 = new Set(["\\smallint"]), se = d((r, e) => {
    var t, a, n = !1, l;
    r.type === "supsub" ? (t = r.sup, a = r.sub, l = F(r.base, "op"), n = !0) : l = F(r, "op");
    var u = e.style, h = !1;
    u.size === O.DISPLAY.size && l.symbol && !x1.has(l.name) && (h = !0);
    var c;
    if (l.symbol) {
        var p = h ? "Size2-Regular" : "Size1-Regular", b = "";
        if ((l.name === "\\oiint" || l.name === "\\oiiint") && (b = l.name.slice(1), l.name = b === "oiint" ? "\\iint" : "\\iiint"), c = u0(l.name, p, "math", e, ["mop", "op-symbol", h ? "large-op" : "small-op"]), b.length > 0) {
            var y = c.italic, x = Xr(b + "Size" + (h ? "2" : "1"), e);
            c = U({
                positionType: "individualShift",
                children: [{type: "elem", elem: c, shift: 0}, {type: "elem", elem: x, shift: h ? .08 : 0}]
            }), l.name = "\\" + b, c.classes.unshift("mop"), c.italic = y
        }
    } else if (l.body) {
        var w = n0(l.body, e, !0);
        w.length === 1 && w[0] instanceof h0 ? (c = w[0], c.classes[0] = "mop") : c = S(["mop"], w, e)
    } else {
        for (var T = [], B = 1; B < l.name.length; B++) T.push(Lt(l.name[B], l.mode, e));
        c = S(["mop"], T, e)
    }
    var q = 0, R = 0;
    return (c instanceof h0 || l.name === "\\oiint" || l.name === "\\oiiint") && !l.suppressBaseShift && (q = (c.height - c.depth) / 2 - e.fontMetrics().axisHeight, R = c.italic || 0), n ? y1(c, t, a, e, u, R, q) : (q && (c.style.position = "relative", c.style.top = M(q)), c)
}, "htmlBuilder$2"), be = d((r, e) => {
    var t;
    if (r.symbol) t = new z("mo", [y0(r.name, r.mode)]), x1.has(r.name) && t.setAttribute("largeop", "false"); else if (r.body) t = new z("mo", g0(r.body, e)); else {
        t = new z("mi", [new _(r.name.slice(1))]);
        var a = new z("mo", [y0("\u2061", "text")]);
        r.parentIsSupSub ? t = new z("mrow", [t, a]) : t = $r([t, a])
    }
    return t
}, "mathmlBuilder$1"), n4 = {
    "\u220F": "\\prod",
...
D({
    type: "op", names: ["\\mathop"], props: {numArgs: 1, primitive: !0}, handler: d((r, e) => {
        var {parser: t} = r, a = e[0];
        return {type: "op", mode: t.mode, limits: !1, parentIsSupSub: !1, symbol: !1, body: e0(a)}
    }, "handler"), htmlBuilder: se, mathmlBuilder: be
});
var i4 = {
    "\u222B": "\\int",
    "\u222C": "\\iint",
...
var w1 = d((r, e) => {
    var t, a, n = !1, l;
    r.type === "supsub" ? (t = r.sup, a = r.sub, l = F(r.base, "operatorname"), n = !0) : l = F(r, "operatorname");
    var u;
    if (l.body.length > 0) {
        for (var h = l.body.map(y => {
            var x = "text" in y ? y.text : void 0;
            return typeof x == "string" ? {type: "textord", mode: y.mode, text: x} : y
        }), c = n0(h, e.withFont("mathrm"), !0), p = 0; p < c.length; p++) {
            var b = c[p];
            b instanceof h0 && (b.text = b.text.replace(/\u2212/, "-").replace(/\u2217/, "*"))
        }
        u = S(["mop"], c, e)
    } else u = S(["mop"], [], e);
    return n ? y1(u, t, a, e, e.style, 0, 0) : u
}, "htmlBuilder$1"), l4 = d((r, e) => {
    for (var t = g0(r.body, e.withFont("mathrm")), a = !0, n = 0; n < t.length; n++) {
        var l = t[n];
        if (!(l instanceof Ve)) if (l instanceof z) switch (l.type) {
            case"mi":
            case"mn":
            case"mspace":
            case"mtext":
    ...
    var p = new z("mo", [y0("\u2061", "text")]);
    return r.parentIsSupSub ? new z("mrow", [c, p]) : $r([c, p])
}, "mathmlBuilder");
D({
    type: "operatorname",
...
Z0({
    type: "ordgroup", htmlBuilder(r, e) {
        return r.semisimple ? N0(n0(r.body, e, !1)) : S(["mord"], n0(r.body, e, !0), e)
    }, mathmlBuilder(r, e) {
        return Y0(r.body, e, !0)
    }
});
D({
    type: "overline", names: ["\\overline"], props: {numArgs: 1}, handler(r, e) {
        var {parser: t} = r, a = e[0];
        return {type: "overline", mode: t.mode, body: a}
    }, htmlBuilder(r, e) {
        var t = V(r.body, e.havingCrampedStyle()), a = ne("overline-line", e), n = e.fontMetrics().defaultRuleThickness,
            l = U({
                positionType: "firstBaseline",
                children: [{type: "elem", elem: t}, {type: "kern", size: 3 * n}, {type: "elem", elem: a}, {
                    type: "kern",
                    size: n
                }]
            });
...
D({
    type: "phantom", names: ["\\phantom"], props: {numArgs: 1, allowedInText: !0}, handler: d((r, e) => {
        var {parser: t} = r, a = e[0];
...
D({
    type: "vphantom", names: ["\\vphantom"], props: {numArgs: 1, allowedInText: !0}, handler: d((r, e) => {
        var {parser: t} = r, a = e[0];
        return {type: "vphantom", mode: t.mode, body: a}
    }, "handler"), htmlBuilder: d((r, e) => {
        var t = S(["inner"], [V(r.body, e.withPhantom())]), a = S(["fix"], []);
        return S(["mord", "rlap"], [t, a], e)
    }, "htmlBuilder"), mathmlBuilder: d((r, e) => {
        var t = g0(e0(r.body), e), a = new z("mphantom", t), n = new z("mpadded", [a]);
...
D({
    type: "internal", names: ["\\relax"], props: {numArgs: 0, allowedInText: !0, allowedInArgument: !0}, handler(r) {
        var {parser: e} = r;
...
D({
    ...
    handler(r, e, t) {
        var {parser: a} = r, n = t[0], l = F(e[0], "size"), u = F(e[1], "size");
        return {type: "rule", mode: a.mode, shift: n && F(n, "size").value, width: l.value, height: u.value}
    },
    htmlBuilder(r, e) {
        var t = S(["mord", "rule"], [], e), a = Q(r.width, e), n = Q(r.height, e), l = r.shift ? Q(r.shift, e) : 0;
    ...
    mathmlBuilder(r, e) {
        var t = Q(r.width, e), a = Q(r.height, e), n = r.shift ? Q(r.shift, e) : 0,
            l = e.color && e.getColor() || "black", u = new z("mspace");
...
function k1(r, e, t) {
    for (var a = n0(r, e, !1), n = e.sizeMultiplier / t.sizeMultiplier, l = 0; l < a.length; l++) {
...
d(k1, "sizingGroup");
var zr = ["\\tiny", "\\sixptsize", "\\scriptsize", "\\footnotesize", "\\small", "\\normalsize", "\\large", "\\Large", "\\LARGE", "\\huge", "\\Huge"],
    s4 = d((r, e) => {
        var t = e.havingSize(r.size);
        return k1(r.body, t, e)
    }, "htmlBuilder");
D({
    type: "sizing", names: zr, props: {numArgs: 0, allowedInText: !0}, handler: d((r, e) => {
        var {breakOnTokenText: t, funcName: a, parser: n} = r, l = n.parseExpression(!1, t);
        return {type: "sizing", mode: n.mode, size: zr.indexOf(a) + 1, body: l}
    }, "handler"), htmlBuilder: s4, mathmlBuilder: d((r, e) => {
        var t = e.havingSize(r.size), a = g0(r.body, t), n = new z("mstyle", a);
...
D({
    ...
    handler: d((r, e, t) => {
        var {parser: a} = r, n = !1, l = !1, u = t[0] && F(t[0], "ordgroup");
        if (u) for (var h = "", c = 0; c < u.body.length; ++c) {
            var p = u.body[c];
            if (h = Je(p).text, h === "t") n = !0; else if (h === "b") l = !0; else {
                n = !1, l = !1;
                break
            }
        } else n = !0, l = !0;
        var b = e[0];
        return {type: "smash", mode: a.mode, body: b, smashHeight: n, smashDepth: l}
    }, "handler"),
    htmlBuilder: d((r, e) => {
        var t = S([], [V(r.body, e)]);
        if (!r.smashHeight && !r.smashDepth) return t;
        if (r.smashHeight && (t.height = 0), r.smashDepth && (t.depth = 0), r.smashHeight && r.smashDepth) return S(["mord", "smash"], [t], e);
...
D({
    type: "sqrt", names: ["\\sqrt"], props: {numArgs: 1, numOptionalArgs: 1}, handler(r, e, t) {
        ...
        var u = n + l / 4, h = t.height + t.depth + u + n, {span: c, ruleWidth: p, advanceWidth: b} = $a(h, e),
            y = c.height - p;
        y > t.height + t.depth + u && (u = (u + y - t.height - t.depth) / 2);
        var x = c.height - t.height - u - p;
        t.style.paddingLeft = M(b);
        var w = U({
            positionType: "firstBaseline",
            children: [{type: "elem", elem: t, wrapperClasses: ["svg-align"]}, {
                type: "kern",
                size: -(t.height + x)
            }, {type: "elem", elem: c}, {type: "kern", size: p}]
        });
        if (r.index) {
            var T = e.havingStyle(O.SCRIPTSCRIPT), B = V(r.index, T, e), q = .6 * (w.height - w.depth),
                R = U({positionType: "shift", positionData: -q, children: [{type: "elem", elem: B}]}),
                N = S(["root"], [R]);
            return S(["mord", "sqrt"], [N, w], e)
        } else return S(["mord", "sqrt"], [w], e)
    }, mathmlBuilder(r, e) {
        var {body: t, index: a} = r;
        return a ? new z("mroot", [W(t, e), W(a, e)]) : new z("msqrt", [W(t, e)])
    }
});
var Ar = {display: O.DISPLAY, text: O.TEXT, script: O.SCRIPT, scriptscript: O.SCRIPTSCRIPT};
D({
    type: "styling",
    names: ["\\displaystyle", "\\textstyle", "\\scriptstyle", "\\scriptscriptstyle"],
    props: {numArgs: 0, allowedInText: !0, primitive: !0},
    handler(r, e) {
        var {breakOnTokenText: t, funcName: a, parser: n} = r, l = n.parseExpression(!0, t),
            u = a.slice(1, a.length - 5);
        return {type: "styling", mode: n.mode, style: u, body: l}
    },
    htmlBuilder(r, e) {
        var t = Ar[r.style], a = e.havingStyle(t).withFont("");
        return k1(r.body, a, e)
    },
    mathmlBuilder(r, e) {
        var t = Ar[r.style], a = e.havingStyle(t), n = g0(r.body, a), l = new z("mstyle", n),
...
var u4 = d(function (e, t) {
    ...
    if (a) if (a.type === "op") {
        ...
        if (a.type === "accent") return E0(a.base) ? Vt : null;
...
Z0({
    type: "supsub", htmlBuilder(r, e) {
        var t = u4(r, e);
        if (t) return t(r, e);
        var {base: a, sup: n, sub: l} = r, u = V(a, e), h, c, p = e.fontMetrics(), b = 0, y = 0, x = a && E0(a);
        if (n) {
            var w = e.havingStyle(e.style.sup());
            h = V(n, w, e), x || (b = u.height - w.fontMetrics().supDrop * w.sizeMultiplier / e.sizeMultiplier)
        }
        if (l) {
            var T = e.havingStyle(e.style.sub());
            c = V(l, T, e), x || (y = u.depth + T.fontMetrics().subDrop * T.sizeMultiplier / e.sizeMultiplier)
        }
        var B;
        e.style === O.DISPLAY ? B = p.sup1 : e.style.cramped ? B = p.sup3 : B = p.sup2;
        var q = e.sizeMultiplier, R = M(.5 / p.ptPerEm / q), N = null;
        if (c) {
            var H = r.base && r.base.type === "op" && r.base.name && (r.base.name === "\\oiint" || r.base.name === "\\oiiint");
            (u instanceof h0 || H) && (N = M(-u.italic))
        }
        var L;
        if (h && c) {
            b = Math.max(b, B, h.depth + .25 * p.xHeight), y = Math.max(y, p.sub2);
            var X = p.defaultRuleThickness, P = 4 * X;
            if (b - h.depth - (c.height - y) < P) {
                y = P - (b - h.depth) + c.height;
                var G = .8 * p.xHeight - (b - h.depth);
                G > 0 && (b += G, y -= G)
            }
            var $ = [{type: "elem", elem: c, shift: y, marginRight: R, marginLeft: N}, {
                type: "elem",
                elem: h,
                shift: -b,
                marginRight: R
            }];
            L = U({positionType: "individualShift", children: $})
        } else if (c) {
            y = Math.max(y, p.sub1, c.height - .8 * p.xHeight);
            var Y = [{type: "elem", elem: c, marginLeft: N, marginRight: R}];
            L = U({positionType: "shift", positionData: y, children: Y})
        } else if (h) b = Math.max(b, B, h.depth + .25 * p.xHeight), L = U({
            positionType: "shift",
            positionData: -b,
            children: [{type: "elem", elem: h, marginRight: R}]
        }); else throw new Error("supsub must have either sup or sub.");
        var c0 = Bt(u, "right") || "mord";
        return S([c0], [u, S(["msupsub"], [L])], e)
    }, mathmlBuilder(r, e) {
        var t = !1, a, n;
        ...
        var u;
        if (t) u = a ? "mover" : "munder"; else if (r.sub) if (r.sup) {
            var p = r.base;
            p && p.type === "op" && p.limits && e.style === O.DISPLAY || p && p.type === "operatorname" && p.alwaysHandleSupSub && (e.style === O.DISPLAY || p.limits) ? u = "munderover" : u = "msubsup"
        } else {
            var c = r.base;
            c && c.type === "op" && c.limits && (e.style === O.DISPLAY || c.alwaysHandleSupSub) || c && c.type === "operatorname" && c.alwaysHandleSupSub && (c.limits || e.style === O.DISPLAY) ? u = "munder" : u = "msub"
        } else {
            var h = r.base;
            h && h.type === "op" && h.limits && (e.style === O.DISPLAY || h.alwaysHandleSupSub) || h && h.type === "operatorname" && h.alwaysHandleSupSub && (h.limits || e.style === O.DISPLAY) ? u = "mover" : u = "msup"
        }
        return new z(u, l)
    }
});
Z0({
    type: "atom", htmlBuilder(r, e) {
        return Lt(r.text, r.mode, e, ["m" + r.family])
    }, mathmlBuilder(r, e) {
        var t = new z("mo", [y0(r.text, r.mode)]);
        if (r.family === "bin") {
            var a = Ut(r, e);
...
var S1 = {mi: "italic", mn: "normal", mtext: "normal"};
Z0({
    type: "mathord", htmlBuilder(r, e) {
        return je(r, e, "mathord")
    }, mathmlBuilder(r, e) {
        var t = new z("mi", [y0(r.text, r.mode, e)]), a = Ut(r, e) || "italic";
        return a !== S1[t.type] && t.setAttribute("mathvariant", a), t
    }
});
Z0({
    type: "textord", htmlBuilder(r, e) {
        return je(r, e, "textord")
    }, mathmlBuilder(r, e) {
        var t = y0(r.text, r.mode, e), a = Ut(r, e) || "normal", n;
        return r.mode === "text" ? n = new z("mtext", [t]) : /[0-9]/.test(r.text) ? n = new z("mn", [t]) : r.text === "\\prime" ? n = new z("mo", [t]) : n = new z("mi", [t]), a !== S1[n.type] && n.setAttribute("mathvariant", a), n
    }
});
var gt = {"\\nobreak": "nobreak", "\\allowbreak": "allowbreak"},
    bt = {" ": {}, "\\ ": {}, "~": {className: "nobreak"}, "\\space": {}, "\\nobreakspace": {className: "nobreak"}};
Z0({
    type: "spacing", htmlBuilder(r, e) {
        if (bt.hasOwnProperty(r.text)) {
            var t = bt[r.text].className || "";
            if (r.mode === "text") {
                var a = je(r, e, "textord");
                return a.classes.push(t), a
            } else return S(["mspace", t], [Lt(r.text, r.mode, e)], e)
        } else {
            if (gt.hasOwnProperty(r.text)) return S(["mspace", gt[r.text]], [], e);
            throw new A('Unknown type of space "' + r.text + '"')
        }
    }, mathmlBuilder(r, e) {
        var t;
        if (bt.hasOwnProperty(r.text)) t = new z("mtext", [new _("\xA0")]); else {
            if (gt.hasOwnProperty(r.text)) return new z("mspace");
            throw new A('Unknown type of space "' + r.text + '"')
        }
        return t
    }
...
Z0({
    type: "tag", mathmlBuilder(r, e) {
        var t = new z("mtable", [new z("mtr", [Mr(), new z("mtd", [Y0(r.body, e)]), Mr(), new z("mtd", [Y0(r.tag, e)])])]);
        return t.setAttribute("width", "100%"), t
    }
});
var Tr = {"\\text": void 0, "\\textrm": "textrm", "\\textsf": "textsf", "\\texttt": "texttt", "\\textnormal": "textrm"},
    Br = {"\\textbf": "textbf", "\\textmd": "textmd"}, o4 = {"\\textit": "textit", "\\textup": "textup"},
    Dr = d((r, e) => {
        var t = r.font;
        if (t) {
            if (Tr[t]) return e.withTextFontFamily(Tr[t]);
            if (Br[t]) return e.withTextFontWeight(Br[t]);
...
D({
    type: "underline", names: ["\\underline"], props: {numArgs: 1, allowedInText: !0}, handler(r, e) {
        var {parser: t} = r;
        return {type: "underline", mode: t.mode, body: e[0]}
    }, htmlBuilder(r, e) {
        var t = V(r.body, e), a = ne("underline-line", e), n = e.fontMetrics().defaultRuleThickness, l = U({
            positionType: "top",
            positionData: t.height,
            children: [{type: "kern", size: n}, {type: "elem", elem: a}, {type: "kern", size: 3 * n}, {
                type: "elem",
                elem: t
            }]
        });
...
D({
    ...
    htmlBuilder(r, e) {
        var t = V(r.body, e), a = e.fontMetrics().axisHeight, n = .5 * (t.height - a - (t.depth + a));
...
D({
    type: "verb", names: ["\\verb"], props: {numArgs: 0, allowedInText: !0}, handler(r, e, t) {
        throw new A("\\verb ended by end of line instead of matching delimiter")
    }, htmlBuilder(r, e) {
        for (var t = Cr(r), a = [], n = e.havingStyle(e.style.text()), l = 0; l < t.length; l++) {
            var u = t[l];
            u === "~" && (u = "\\textasciitilde"), a.push(u0(u, "Typewriter-Regular", r.mode, n, ["mord", "texttt"]))
        }
        return S(["mord", "text"].concat(n.sizingClasses(e)), Gr(a), n)
    }, mathmlBuilder(r, e) {
        var t = new _(Cr(r)), a = new z("mtext", [t]);
        return a.setAttribute("mathvariant", "monospace"), a
    }
});
var Cr = d(r => r.body.replace(/ /g, r.star ? "\u2423" : "\xA0"), "makeVerb"), P0 = Yr, z1 = `[ \r
	]`, h4 = "\\\\[a-zA-Z@]+", m4 = "\\\\[^\uD800-\uDFFF]", c4 = "(" + h4 + ")" + z1 + "*", d4 = `\\\\(
|[ \r	]+
?)[ \r	]*`, Et = "[\u0300-\u036F]", f4 = new RegExp(Et + "+$"),
    v4 = "(" + z1 + "+)|" + (d4 + "|") + "([!-\\[\\]-\u2027\u202A-\uD7FF\uF900-\uFFFF]" + (Et + "*") + "|[\uD800-\uDBFF][\uDC00-\uDFFF]" + (Et + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + c4) + ("|" + m4 + ")"),
    Ye = class {
        static {
            d(this, "Lexer")
        }
        ...
        constructor(e, t) {
            this.input = e, this.settings = t, this.tokenRegex = new RegExp(v4, "g"), this.catcodes = {"%": 14, "~": 13}
        }
        ...
        lex() {
            ...
            if (t === e.length) return new v0("EOF", new f0(this, t, t));
            var a = this.tokenRegex.exec(e);
            if (a === null || a.index !== t) throw new A("Unexpected character: '" + e[t] + "'", new v0(e[t], new f0(this, t, t + 1)));
            var n = a[6] || a[3] || (a[2] ? "\\ " : " ");
...
`, this.tokenRegex.lastIndex);
            ...
            return new v0(n, new f0(this, t, this.tokenRegex.lastIndex))
        }
    }, It = class {
        static {
            d(this, "Namespace")
...
m("\\char", function (r) {
    ...
    if (e.text === "'") t = 8, e = r.popToken(); else if (e.text === '"') t = 16, e = r.popToken(); else if (e.text === "`") if (e = r.popToken(), e.text[0] === "\\") a = e.text.charCodeAt(1); else {
        if (e.text === "EOF") throw new A("\\char` missing argument");
        a = e.text.charCodeAt(0)
    } else t = 10;
    if (t) {
        if (a = qr[e.text], a == null || a >= t) throw new A("Invalid base-" + t + " digit " + e.text);
        for (var n; (n = qr[r.future().text]) != null && n < t;) a *= t, a += n, r.popToken()
    }
    return "\\@char{" + a + "}"
});
var $t = d((r, e, t, a) => {
    ...
    if (!u && !t) throw new A("\\renewcommand{" + l + "} when command " + l + " does not yet exist; use \\newcommand");
    var h = 0;
...
m("\\newcommand", r => $t(r, !1, !0, !1));
m("\\renewcommand", r => $t(r, !0, !1, !1));
m("\\providecommand", r => $t(r, !0, !0, !0));
m("\\message", r => {
...
m("\\show", r => {
    ...
    return console.log(e, r.macros.get(t), P0[t], j.math[t], j.text[t]), ""
});
m("\\bgroup", "{");
m("\\egroup", "}");
m("~", "\\nobreakspace");
...
m("\\dots", function (r) {
    ...
    return t in Rr ? e = Rr[t] : (t.slice(0, 4) === "\\not" || t in j.math && g4.has(j.math[t].group)) && (e = "\\dotsb"), e
});
var jt = {
    ")": !0,
    "]": !0,
...
var A1 = M(A0["Main-Regular"][84][1] - .7 * A0["Main-Regular"][65][1]);
m("\\LaTeX", "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + A1 + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}");
m("\\KaTeX", "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + A1 + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}");
...
var M1 = d(r => e => {
    var t = e.consumeArg().tokens, a = e.consumeArg().tokens, n = e.consumeArg().tokens, l = e.consumeArg().tokens,
        u = e.macros.get("|"), h = e.macros.get("\\|");
    e.macros.beginGroup();
    var c = d(y => x => {
...
var T1 = {"^": !0, _: !0, "\\limits": !0, "\\nolimits": !0}, Nt = class {
    static {
        d(this, "MacroExpander")
    }

    constructor(e, t, a) {
        this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new It(p4, t.macros), this.mode = a, this.stack = []
    }

    feed(e) {
        this.lexer = new Ye(e, this.settings)
    }
    ...
    scanArgument(e) {
        ...
        return this.pushToken(new v0("EOF", a.loc)), this.pushTokens(n), new v0("", f0.range(t, a))
    }

    consumeSpaces() {
        for (; ;) {
            var e = this.future();
            if (e.text === " ") this.stack.pop(); else break
        }
    }
    ...
    consumeArg(e) {
        ...
        do {
            if (l = this.popToken(), t.push(l), l.text === "{") ++u; else if (l.text === "}") {
                if (--u, u === -1) throw new A("Extra }", l)
            } else if (l.text === "EOF") throw new A("Unexpected end of input in a macro argument, expected '" + (e && a ? e[h] : "}") + "'", l);
    ...
    consumeArgs(e, t) {
        if (t) {
            ...
            for (var a = t[0], n = 0; n < a.length; n++) {
                var l = this.popToken();
                if (a[n] !== l.text) throw new A("Use of the macro doesn't match its definition", l)
            }
        }
    ...
    expandOnce(e) {
        ...
        if (n.numArgs) {
            ...
            for (var h = l.length - 1; h >= 0; --h) {
                var c = l[h];
                if (c.text === "#") {
                    if (h === 0) throw new A("Incomplete placeholder at end of macro body", c);
                    if (c = l[--h], c.text === "#") l.splice(h + 1, 1); else if (/^[1-9]$/.test(c.text)) l.splice(h, 2, ...u[+c.text - 1]); else throw new A("Not a valid argument number", c)
                }
            }
        }
    ...
    _getExpansion(e) {
        ...
        if (typeof n == "string") {
            ...
            for (var h = new Ye(n, this.settings), c = [], p = h.lex(); p.text !== "EOF";) c.push(p), p = h.lex();
            c.reverse();
            var b = {tokens: c, numArgs: l};
            return b
        }
        return n
    }
    ...
    isDefined(e) {
        return this.macros.has(e) || P0.hasOwnProperty(e) || j.math.hasOwnProperty(e) || j.text.hasOwnProperty(e) || T1.hasOwnProperty(e)
    }
...
}, Er = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, Ne = Object.freeze({
    "\u208A": "+",
    "\u208B": "-",
    "\u208C": "=",
    "\u208D": "(",
    ...
    constructor(e, t) {
        this.mode = "math", this.gullet = new Nt(e, t, this.mode), this.settings = t, this.leftrightDepth = 0, this.nextToken = null
    }

    expect(e, t) {
        if (t === void 0 && (t = !0), this.fetch().text !== e) throw new A("Expected '" + e + "', got '" + this.fetch().text + "'", this.fetch());
        t && this.consume()
    }
    ...
    parseExpression(e, t) {
        for (var a = []; ;) {
            ...
            var n = this.fetch();
            if (r.endOfExpression.has(n.text) || t && n.text === t || e && P0[n.text] && P0[n.text].infix) break;
    ...
    handleInfixNodes(e) {
        for (var t = -1, a, n = 0; n < e.length; n++) {
            var l = e[n];
            if (l.type === "infix") {
                if (t !== -1) throw new A("only one infix operator per group", l.token);
                t = n, a = l.replaceWith
            }
        }
        if (t !== -1 && a) {
            ...
            var b;
            return a === "\\\\abovefrac" ? b = this.callFunction(a, [u, e[t], h], []) : b = this.callFunction(a, [u, h], []), [b]
        } else return e
    }
    ...
    parseAtom(e) {
        ...
        for (var a, n; ;) {
            ...
            if (l.text === "\\limits" || l.text === "\\nolimits") {
                ...
                } else if (t && t.type === "operatorname") t.alwaysHandleSupSub && (t.limits = l.text === "\\limits"); else throw new A("Limit controls must follow a math operator", l);
                this.consume()
            } else if (l.text === "^") {
                if (a) throw new A("Double superscript", l);
                a = this.handleSupSubscript("superscript")
            } else if (l.text === "_") {
                if (n) throw new A("Double subscript", l);
                ...
                var p = Er.test(l.text), b = [];
                for (b.push(new v0(Ne[l.text])), this.consume(); ;) {
                    var y = this.fetch().text;
                    if (!Ne[y] || Er.test(y) !== p) break;
                    b.unshift(new v0(Ne[y])), this.consume()
                }
                var x = this.subparse(b);
                p ? n = {type: "ordgroup", mode: "math", body: x} : a = {type: "ordgroup", mode: "math", body: x}
            } else break
        }
    ...
    parseFunction(e, t) {
        var a = this.fetch(), n = a.text, l = P0[n];
        if (!l) return null;
        if (this.consume(), t && t !== "atom" && !l.allowedInArgument) throw new A("Got function '" + n + "' with no arguments" + (t ? " as " + t : ""), a);
        if (this.mode === "text" && !l.allowedInText) throw new A("Can't use function '" + n + "' in text mode", a);
        if (this.mode === "math" && l.allowedInMath === !1) throw new A("Can't use function '" + n + "' in math mode", a);
        var {args: u, optArgs: h} = this.parseArguments(n, l);
        return this.callFunction(n, u, h, a, e)
    }

    callFunction(e, t, a, n, l) {
        var u = {funcName: e, parser: this, token: n, breakOnTokenText: l}, h = P0[e];
    ...
    parseArguments(e, t) {
        ...
        for (var n = [], l = [], u = 0; u < a; u++) {
            ...
            if (c) l.push(p); else if (p != null) n.push(p); else throw new A("Null argument, please report this as a bug")
        }
    ...
    parseGroupOfType(e, t, a) {
        switch (t) {
            ...
            case"primitive": {
                ...
                if (u == null) throw new A("Expected group as " + e, this.fetch());
                return u
            }
            case"original":
            case null:
    ...
    parseRegexGroup(e, t) {
        ...
        if (l === "") throw new A("Invalid " + t + ": '" + a.text + "'", a);
        return a.range(n, l)
    }
    ...
    parseSizeGroup(e) {
        ...
        if (!Or(l)) throw new A("Invalid unit: '" + l.unit + "'", t);
    ...
    parseGroup(e, t) {
        ...
        } else if (l = this.parseFunction(t, e) || this.parseSymbol(), l == null && n[0] === "\\" && !T1.hasOwnProperty(n)) {
    ...
    parseSymbol() {
        ...
        Ir.hasOwnProperty(t[0]) && !j[this.mode][t[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = Ir[t[0]] + t.slice(1));
        var l = f4.exec(t);
        ...
        if (j[this.mode][t]) {
            ...
            var h = j[this.mode][t].group, c = f0.range(e), p;
            if (va.hasOwnProperty(h)) {
                var b = h;
                p = {type: "atom", mode: this.mode, family: b, loc: c, text: t}
            } else p = {type: h, mode: this.mode, loc: c, text: t};
            u = p
        } else if (t.charCodeAt(0) >= 128) this.settings.strict && (Nr(t.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '"' + (" (" + t.charCodeAt(0) + ")"), e)), u = {
            type: "textord",
            mode: "text",
            loc: f0.range(e),
            text: t
        }; else return null;
        if (this.consume(), l) for (var y = 0; y < l[0].length; y++) {
            var x = l[0][y];
            if (!yt[x]) throw new A("Unknown accent ' " + x + "'", e);
            var w = yt[x][this.mode] || yt[x].text;
            if (!w) throw new A("Accent " + x + " unsupported in " + this.mode + " mode", e);
            u = {type: "accent", mode: this.mode, loc: f0.range(e), label: w, isStretchy: !1, isShifty: !0, base: u}
        }
        return u
    }
};
We.endOfExpression = new Set(["}", "\\endgroup", "\\end", "\\right", "&"]);
var Zt = d(function (e, t) {
    ...
    if (delete a.gullet.macros.current["\\current@color"], delete a.gullet.macros.current["\\color"], a.gullet.macros.get("\\df@tag")) {
        ...
        n = [{type: "tag", mode: "text", body: n, tag: a.subparse([new v0("\\df@tag")])}]
    }
    return n
}, "parseTree"), B1 = d(function (e, t, a) {
    t.textContent = "";
    var n = Kt(e, a).toNode();
    t.appendChild(n)
}, "render");
typeof document < "u" && document.compatMode !== "CSS1Compat" && (typeof console < "u" && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), B1 = d(function () {
    throw new A("KaTeX doesn't work in quirks mode.")
}, "render"));
var b4 = d(function (e, t) {
        var a = Kt(e, t).toMarkup();
        return a
    }, "renderToString"), y4 = d(function (e, t) {
        var a = new de(t);
        return Zt(e, a)
    }, "generateParseTree"), D1 = d(function (e, t, a) {
        if (a.throwOnError || !(e instanceof A)) throw e;
        var n = S(["katex-error"], [new h0(t)]);
        return n.setAttribute("title", e.toString()), n.setAttribute("style", "color:" + a.errorColor), n
    }, "renderError"), Kt = d(function (e, t) {
        var a = new de(t);
        try {
            var n = Zt(e, a);
            return qa(n, e, a)
    ...
    }, "renderToDomTree"), x4 = d(function (e, t) {
        var a = new de(t);
        try {
            var n = Zt(e, a);
            return Ra(n, e, a)
    ...
    }, "renderToHTMLTree"), w4 = "0.16.45",
    k4 = {Span: V0, Anchor: ae, SymbolNode: h0, SvgNode: k0, PathNode: M0, LineNode: ve}, S4 = {
        version: w4,
        render: B1,
        renderToString: b4,
        ParseError: A,
        SETTINGS_SCHEMA: xt,
        __parse: y4,
        __renderToDomTree: Kt,
        __renderToHTMLTree: x4,
        __setFontMetrics: da,
        __defineSymbol: i,
        __defineFunction: D,
        __defineMacro: m,
...
export {
    A as ParseError,
    xt as SETTINGS_SCHEMA,
    D as __defineFunction,
    m as __defineMacro,
    i as __defineSymbol,
    k4 as __domTree,
    y4 as __parse,
    Kt as __renderToDomTree,
    x4 as __renderToHTMLTree,
    da as __setFontMetrics,
    S4 as default,
    B1 as render,
    b4 as renderToString,
    w4 as version
};
