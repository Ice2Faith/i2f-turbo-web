import {a as ke} from "./chunk-Y3FQM624.mjs";
import {a as ye} from "./chunk-AZZRMDJM.mjs";
import {a as de, b as pe} from "./chunk-7FYTHRHK.mjs";
import {e as fe, g as me, j as be} from "./chunk-KTKOSTGQ.mjs";
...
import {A as B, P as ue, _ as V, d as ge, e as te, f as ne, j as F} from "./chunk-KEUXMURM.mjs";
import {b as W} from "./chunk-LIEV3EAG.mjs";
import {a as o} from "./chunk-AQ6EADP3.mjs";

var ie = (function () {
    var e = o(function (v, i, n, s) {
            for (n = n || {}, s = v.length; s--; n[v[s]] = i) ;
            return n
        }, "o"), g = [1, 4], p = [1, 13], r = [1, 12], d = [1, 15], k = [1, 16], y = [1, 20], l = [1, 19], L = [6, 7, 8],
        C = [1, 26], u = [1, 24], w = [1, 25], E = [6, 7, 11], K = [1, 31], N = [6, 7, 11, 24],
        M = [1, 6, 13, 16, 17, 20, 23], f = [1, 35], A = [1, 36], O = [1, 6, 7, 11, 13, 16, 17, 20, 23], U = [1, 38],
        T = {
            trace: o(function () {
            }, "trace"),
            yy: {},
            ...
            table: [{3: 1, 4: 2, 5: 3, 6: [1, 5], 8: g}, {1: [3]}, {1: [2, 1]}, {
                4: 6,
                6: [1, 7],
                7: [1, 8],
                8: g
                ...
                20: y,
                23: l
            }, {6: p, 9: 22, 12: 11, 13: r, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: y, 23: l}, {
                6: C,
                7: u,
                10: 23,
                11: w
                ...
                15: 30,
                24: K
            }), e(E, [2, 22]), e(E, [2, 23]), e(N, [2, 25]), e(N, [2, 26]), e(N, [2, 28], {20: [1, 32]}), {21: [1, 33]}, {
                6: C,
                7: u,
                10: 34,
                11: w
                ...
                20: y,
                23: l
            }, e(M, [2, 14], {7: f, 11: A}), e(O, [2, 8]), e(O, [2, 9]), e(O, [2, 10]), e(E, [2, 16], {
                15: 37,
                24: K
            }), e(E, [2, 17]), e(E, [2, 18]), e(E, [2, 20], {24: U}), e(N, [2, 31]), {21: [1, 39]}, {22: [1, 40]}, e(M, [2, 13], {
                7: f,
                11: A
            }), e(O, [2, 11]), e(O, [2, 12]), e(E, [2, 15], {24: U}), e(N, [2, 30]), {22: [1, 41]}, e(N, [2, 27]), e(N, [2, 29])],
            defaultActions: {2: [2, 1], 6: [2, 2]},
            parseError: o(function (i, n) {
                if (n.recoverable) this.trace(i); else {
                    var s = new Error(i);
                    throw s.hash = n, s
                }
            }, "parseError"),
            parse: o(function (i) {
                var n = this, s = [0], a = [], h = [null], t = [], R = this.table, c = "", z = 0, ae = 0, ce = 0,
                    xe = 2, le = 1, Le = t.slice.call(arguments, 1), b = Object.create(this.lexer), P = {yy: {}};
...
Expecting ` + Y.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : ee = "Parse error on line " + (z + 1) + ": Unexpected " + (_ == le ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(ee, {
                    ...
                    switch (D[0]) {
                        ...
                        case 2:
                            ...
                            }, Oe && (G._$.range = [t[t.length - (I || 1)].range[0], t[t.length - 1].range[1]]), $ = this.performAction.apply(G, [c, ae, z, P.yy, D[1], h, t].concat(Le)), typeof $ < "u") return $;
            ...
            var v = {
                ...
                parseError: o(function (n, s) {
                    if (this.yy.parser) this.yy.parser.parseError(n, s); else throw new Error(n)
                }, "parseError"),
...
` + this.showPosition(), {text: "", token: null, line: this.yylineno})
    ...
    return o(H, "Parser"), H.prototype = T, T.Parser = H, new H
})();
ie.parser = ie;
var Ee = ie;
var x = [], se = [], re = 0, oe = {}, Ce = o(() => {
        x = [], se = [], re = 0, oe = {}
    }, "clear"), Ie = o(e => {
    ...
    }, "getSection"), _e = o(function () {
        return se
    }, "getSections"), we = o(function () {
        let e = [], g = [], p = _e(), r = V();
        for (let d of p) {
            let k = {
                id: d.id,
        ...
        return {nodes: g, edges: e, other: {}, config: V()}
    }, "getData"), Ae = o((e, g, p, r, d) => {
        let k = V(), y = k.mindmap?.padding ?? F.mindmap.padding;
        switch (r) {
            case m.ROUNDED_RECT:
            case m.RECT:
            case m.HEXAGON:
        ...
        let l = {
            ...
            level: e,
            label: B(p, k),
            width: k.mindmap?.maxNodeWidth ?? F.mindmap.maxNodeWidth,
            padding: y,
            isGroup: !1
        };
        if (d !== void 0) {
...
` + d + `
    ...
    }, "addNode"), m = {DEFAULT: 0, NO_BORDER: 0, ROUNDED_RECT: 1, RECT: 2, CIRCLE: 3, CLOUD: 4, BANG: 5, HEXAGON: 6},
    Te = o((e, g) => {
        switch (W.debug("In get type", e, g), e) {
            case"[":
                return m.RECT;
            case"(":
                return g === ")" ? m.ROUNDED_RECT : m.CLOUD;
            case"((":
                return m.CIRCLE;
            case")":
                return m.CLOUD;
        ...
        oe[e] = g
    }, "setElementForId"), Pe = o(e => {
        if (!e) return;
        let g = V(), p = x[x.length - 1];
        e.icon && (p.icon = B(e.icon, g)), e.class && (p.cssClasses = B(e.class, g))
    }, "decorateNode"), je = o(e => {
        switch (e) {
            case m.DEFAULT:
                return "no-border";
    ...
    }, "type2Str"), Be = o(() => W, "getLogger"), Ve = o(e => oe[e], "getElementById"), Me = {
        clear: Ce,
        addNode: Ae,
        getSections: _e,
        getData: we,
...
var Ge = o(async (e, g, p, r) => {
    W.debug(`Rendering kanban diagram
` + e);
    let k = r.db.getData(), y = V();
    y.htmlLabels = !1;
    let l = ke(g);
    ...
    for (let f of u) {
        ...
        for (let i of J) {
            ...
            let s = (await me(C, i, {config: y})).node().getBBox();
            i.y = T + s.height / 2, await be(i), T = i.y + s.height / 2 + E / 2
        }
        let H = A.cluster.select("rect"), v = Math.max(T - U + 3 * E, 50) + (N - 25);
        H.attr("height", v)
    }
    ue(void 0, l, y.mindmap?.padding ?? F.kanban.padding, y.mindmap?.useMaxWidth ?? F.kanban.useMaxWidth)
}, "draw"), Ne = {draw: Ge};
var Fe = o(e => {
    let g = "";
    for (let r = 0; r < e.THEME_COLOR_LIMIT; r++) e["lineColor" + r] = e["lineColor" + r] || e["cScaleInv" + r], ge(e["lineColor" + r]) ? e["lineColor" + r] = te(e["lineColor" + r], 20) : e["lineColor" + r] = ne(e["lineColor" + r], 20);
    let p = o((r, d) => e.darkMode ? ne(r, d) : te(r, d), "adjuster");
