...
c(Je, "isNegativeZero");
var en = _e, nn = Ve, rn = Xe, ln = ze, on = Je, un = Ze,
    C = {isNothing: en, isObject: nn, toArray: rn, repeat: ln, isNegativeZero: on, extend: un};
...
B.prototype.toString = c(function (n) {
...
function fn(e, n) {
    ...
    o < 0 && (o = l.length - 1);
    var f = "", a, p, h = Math.min(e.line + n.linesAfter, r.length).toString().length,
...
c(fn, "makeSnippet");
var cn = fn,
    an = ["kind", "multi", "resolve", "construct", "instanceOf", "predicate", "represent", "representName", "defaultStyle", "styleAliases"],
    pn = ["scalar", "sequence", "mapping"];
...
function dn() {
    ...
    for (c(l, "collectType"), n = 0, i = arguments.length; n < i; n += 1) arguments[n].forEach(l);
    return e
}
...
c(Z, "Schema$1");
Z.prototype.extend = c(function (n) {
    var i = [], l = [];
...
var sn = Z, mn = new _("tag:yaml.org,2002:str", {
    kind: "scalar", construct: c(function (e) {
        return e !== null ? e : ""
    }, "construct")
}), xn = new _("tag:yaml.org,2002:seq", {
    kind: "sequence", construct: c(function (e) {
        return e !== null ? e : []
    }, "construct")
}), gn = new _("tag:yaml.org,2002:map", {
    kind: "mapping", construct: c(function (e) {
        return e !== null ? e : {}
    }, "construct")
}), An = new sn({explicit: [mn, xn, gn]});
...
c(vn, "resolveYamlNull");

function yn() {
    return null
}

c(yn, "constructYamlNull");
...
var _n = new _("tag:yaml.org,2002:null", {
    ...
    represent: {
        canonical: c(function () {
            return "~"
        }, "canonical"), lowercase: c(function () {
            return "null"
        }, "lowercase"), uppercase: c(function () {
            return "NULL"
        }, "uppercase"), camelcase: c(function () {
            return "Null"
        }, "camelcase"), empty: c(function () {
            return ""
        }, "empty")
    },
...
c(wn, "resolveYamlBoolean");

function En(e) {
    return e === "true" || e === "True" || e === "TRUE"
}

c(En, "constructYamlBoolean");
...
var Fn = new _("tag:yaml.org,2002:bool", {
    ...
    predicate: Sn,
    represent: {
        lowercase: c(function (e) {
            return e ? "true" : "false"
        }, "lowercase"), uppercase: c(function (e) {
            return e ? "TRUE" : "FALSE"
        }, "uppercase"), camelcase: c(function (e) {
            return e ? "True" : "False"
        }, "camelcase")
    },
    defaultStyle: "lowercase"
...
var Nn = new _("tag:yaml.org,2002:int", {
        ...
        represent: {
            ...
            }, "binary"), octal: c(function (e) {
                return e >= 0 ? "0o" + e.toString(8) : "-0o" + e.toString(8).slice(1)
            }, "octal"), decimal: c(function (e) {
                return e.toString(10)
            }, "decimal"), hexadecimal: c(function (e) {
    ...
    Rn = new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");

function Dn(e) {
    return !(e === null || !Rn.test(e) || e[e.length - 1] === "_")
}

c(Dn, "resolveYamlFloat");
...
c(Kn, "constructYamlTimestamp");

function qn(e) {
    return e.toISOString()
}

c(qn, "representYamlTimestamp");
...
c(Wn, "resolveYamlMerge");
var $n = new _("tag:yaml.org,2002:merge", {kind: "scalar", resolve: Wn}), ie = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
...
function ni(e) {
    ...
    for (i = 0, l = f.length; i < l; i += 1) {
        ...
        for (u in r) if (Jn.call(r, u)) if (!o) o = !0; else return !1;
        if (!o) return !1;
...
c(ni, "resolveYamlOmap");

function ii(e) {
    return e !== null ? e : []
}

c(ii, "constructYamlOmap");
...
c(pi, "constructYamlSet");
var ti = new _("tag:yaml.org,2002:set", {kind: "mapping", resolve: ai, construct: pi}),
    be = jn.extend({implicit: [Gn, $n], explicit: [zn, ri, fi, ti]}), I = Object.prototype.hasOwnProperty, U = 1,
    Te = 2, Oe = 3, K = 4, X = 1, hi = 2, ce = 3,
    di = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,
    si = /[\x85\u2028\u2029]/, mi = /[,\[\]\{\}]/, Ie = /^(?:!|!!|![a-z\-]+!)$/i,
...
c(pe, "simpleEscapeSequence");

function vi(e) {
    return e <= 65535 ? String.fromCharCode(e) : String.fromCharCode((e - 65536 >> 10) + 55296, (e - 65536 & 1023) + 56320)
}

c(vi, "charFromCodepoint");
...
var te = {
    ...
    }, "handleYamlDirective"), TAG: c(function (n, i, l) {
        var r, u;
...
function O(e, n, i, l) {
    var r, u, o, f;
    if (n < i) {
        if (f = e.input.slice(n, i), l) for (r = 0, u = f.length; r < u; r += 1) o = f.charCodeAt(r), o === 9 || 32 <= o && o <= 1114111 || d(e, "expected valid JSON character"); else di.test(f) && d(e, "the stream contains non-printable characters");
        e.result += f
    }
}
...
function wi(e, n) {
    ...
    for (e.kind = "scalar", e.result = "", e.position++, i = l = e.position; (f = e.input.charCodeAt(e.position)) !== 0;) {
        ...
        if (f === 92) {
            if (O(e, i, e.position, !0), f = e.input.charCodeAt(++e.position), b(f)) y(e, !1, n); else if (f < 256 && Ne[f]) e.result += Re[f], e.position++; else if ((o = gi(f)) > 0) {
...
c(wi, "readDoubleQuotedScalar");

function Ei(e, n) {
    var i = !0, l, r, u, o = e.tag, f, a = e.anchor, p, h, t, s, m, x = Object.create(null), A, v, F, g;
    if (g = e.input.charCodeAt(e.position), g === 91) h = 93, m = !1, f = []; else if (g === 123) h = 125, m = !0, f = {}; else return !1;
...
c(Ei, "readFlowCollection");

function Si(e, n) {
    var i, l, r = X, u = !1, o = !1, f = n, a = 0, p = !1, h, t;
    if (t = e.input.charCodeAt(e.position), t === 124) l = !1; else if (t === 62) l = !0; else return !1;
    for (e.kind = "scalar", e.result = ""; t !== 0;) if (t = e.input.charCodeAt(++e.position), t === 43 || t === 45) X === r ? r = t === 43 ? ce : hi : d(e, "repeat of a chomping mode identifier"); else if ((h = Ai(t)) >= 0) h === 0 ? d(e, "bad explicit indentation width of a block scalar; it cannot be less than one") : o ? d(e, "repeat of an indentation width identifier") : (f = n + h - 1, o = !0); else break;
    if (k(t)) {
...
c(de, "readBlockSequence");

function Fi(e, n, i) {
    var l, r, u, o, f, a, p = e.tag, h = e.anchor, t = {}, s = Object.create(null), m = null, x = null, A = null,
        v = !1, F = !1, g;
    if (e.firstTabInLine !== -1) return !1;
    for (e.anchor !== null && (e.anchorMap[e.anchor] = t), g = e.input.charCodeAt(e.position); g !== 0;) {
        if (!v && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, d(e, "tab characters must not be used in indentation")), l = e.input.charCodeAt(e.position + 1), u = e.line, (g === 63 || g === 58) && S(l)) g === 63 ? (v && (D(e, t, s, m, x, null, o, f, a), m = x = A = null), F = !0, v = !0, r = !0) : v ? (v = !1, r = !0) : d(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, g = l; else {
            ...
            if (e.line === u) {
                ...
                if (g === 58) g = e.input.charCodeAt(++e.position), S(g) || d(e, "a whitespace character is expected after the key-value separator within a block mapping"), v && (D(e, t, s, m, x, null, o, f, a), m = x = A = null), F = !0, v = !1, r = !1, m = e.tag, x = e.result; else if (F) d(e, "can not read an implicit mapping pair; a colon is missed"); else return e.tag = p, e.anchor = h, !0
        ...
        if ((e.line === u || e.lineIndent > n) && (v && (o = e.line, f = e.lineStart, a = e.position), M(e, n, K, !0, r) && (v ? x = e.result : A = e.result), v || (D(e, t, s, m, x, A, o, f, a), m = x = A = null), y(e, !0, -1), g = e.input.charCodeAt(e.position)), (e.line === u || e.lineIndent > n) && g !== 0) d(e, "bad indentation of a mapping entry"); else if (e.lineIndent < n) break
    }
    return v && D(e, t, s, m, x, null, o, f, a), F && (e.tag = p, e.anchor = h, e.kind = "mapping", e.result = t), F
}

c(Fi, "readBlockMapping");
...
function M(e, n, i, l, r) {
    ...
    if (f && (f = p || r), (a === 1 || K === i) && (U === i || Te === i ? A = n : A = n + 1, v = e.position - e.lineStart, a === 1 ? f && (de(e, v) || Fi(e, v, A)) || Ei(e, A) ? h = !0 : (o && Si(e, A) || _i(e, A) || wi(e, A) ? h = !0 : Oi(e) ? (h = !0, (e.tag !== null || e.anchor !== null) && d(e, "alias node should not have any properties")) : Ci(e, A, U === i) && (h = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : a === 0 && (h = f && de(e, v))), e.tag === null) e.anchor !== null && (e.anchorMap[e.anchor] = e.result); else if (e.tag === "?") {
        ...
        if (I.call(e.typeMap[e.kind || "fallback"], e.tag)) x = e.typeMap[e.kind || "fallback"][e.tag]; else for (x = null, m = e.typeMap.multi[e.kind || "fallback"], t = 0, s = m.length; t < s; t += 1) if (e.tag.slice(0, m[t].tag.length) === m[t].tag) {
            x = m[t];
            break
        }
...
c(ki, "load$1");
var Ni = Li, Ri = ki, Ye = {loadAll: Ni, load: Ri}, Be = Object.prototype.toString,
    Pe = Object.prototype.hasOwnProperty, oe = 65279, Di = 9, P = 10, Mi = 13, Yi = 32, Bi = 33, Pi = 34, z = 35,
    Hi = 37, ji = 38, Ui = 39, Ki = 42, He = 44, qi = 45, G = 58, Gi = 61, Wi = 62, $i = 63, Qi = 64, je = 91, Ue = 93,
    Vi = 96, Ke = 123, Xi = 124, qe = 125, w = {};
w[0] = "\\0";
w[7] = "\\a";
w[8] = "\\b";
w[9] = "\\t";
...
c(lr, "isPlainSafeFirst");

function or(e) {
    return !W(e) && e !== G
}

c(or, "isPlainSafeLast");
...
function ur(e, n, i, l, r, u, o, f) {
    ...
    if (n || o) for (a = 0; a < e.length; p >= 65536 ? a += 2 : a++) {
        ...
        for (a = 0; a < e.length; p >= 65536 ? a += 2 : a++) {
            if (p = Y(e, a), p === P) t = !0, m && (s = s || a - x - 1 > l && e[x + 1] !== " ", x = a); else if (!j(p)) return N;
            A = A && xe(p, h, f), h = p
        }
        s = s || m && a - x - 1 > l && e[x + 1] !== " "
    }
...
function fr(e, n, i, l, r) {
    e.dump = (function () {
        ...
        switch (c(a, "testAmbiguity"), ur(n, f, e.indent, o, a, e.quotingType, e.forceQuotes && !l, r)) {
            case We:
                return n;
            case ee:
                return "'" + n.replace(/'/g, "''") + "'";
...
function Ce(e, n, i) {
    ...
    for (r = i ? e.explicitTypes : e.implicitTypes, u = 0, o = r.length; u < o; u += 1) if (f = r[u], (f.instanceOf || f.predicate) && (!f.instanceOf || typeof n == "object" && n instanceof f.instanceOf) && (!f.predicate || f.predicate(n))) {
        if (i ? f.multi && f.representName ? e.tag = f.representName(n) : e.tag = f.tag : e.tag = "?", f.represent) {
            if (a = e.styleMap[f.tag] || f.defaultStyle, Be.call(f.represent) === "[object Function]") l = f.represent(n, a); else if (Pe.call(f.represent, a)) l = f.represent[a](n, a); else throw new E("!<" + f.tag + '> tag resolver accepts not "' + a + '" style');
            e.dump = l
        }
        return !0
    }
...
function T(e, n, i, l, r, u, o) {
    ...
    if (h && (t = e.duplicates.indexOf(i), s = t !== -1), (e.tag !== null && e.tag !== "?" || s || e.indent !== 2 && n > 0) && (r = !1), s && e.usedDuplicates[t]) e.dump = "*ref_" + t; else {
        if (h && s && !e.usedDuplicates[t] && (e.usedDuplicates[t] = !0), f === "[object Object]") l && Object.keys(e.dump).length !== 0 ? (hr(e, n, e.dump, r), s && (e.dump = "&ref_" + t + e.dump)) : (tr(e, n, e.dump), s && (e.dump = "&ref_" + t + " " + e.dump)); else if (f === "[object Array]") l && e.dump.length !== 0 ? (e.noArrayIndent && !o && n > 0 ? ye(e, n - 1, e.dump, r) : ye(e, n, e.dump, r), s && (e.dump = "&ref_" + t + e.dump)) : (pr(e, n, e.dump), s && (e.dump = "&ref_" + t + " " + e.dump)); else if (f === "[object String]") e.tag !== "?" && fr(e, e.dump, n, u, a); else {
...
c(ue, "renamed");
var gr = Ee;
var Ar = Ye.load, vr = Ye.loadAll, yr = xr.dump;
var Cr = ue("safeLoad", "load"), _r = ue("safeLoadAll", "loadAll"), wr = ue("safeDump", "dump");
export {gr as a, Ar as b};
